                  ...
                  <li>
                    ...
                    <br/>
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> RAPPORT DES ENTREES </b>
  											<!-- <a href='bilan_entrees.php' style="color:rgb(255, 213, 29);" title="Retournez au rapports des membres" class="pull-right"> <b> Retour </b> </a> -->
  										 </div>
												    ...
												    <tbody>
												    	<?php
															...
															$fetch_culte_c=$out_culte_c->fetch();
													    		?>
												      <tr>
												        <td><a href="bilan_entrees_stat.php?culte=<?php echo $fetch_culte_c['eid']; ?>&bid=<?php echo $bid ;?>"><?php echo $fetch_culte_c["evenement"]; ?> </a></td>
												      </tr>
												      <?php 
													  		} 
													  		?>
