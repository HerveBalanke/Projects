          ...
          <div class="col-md-12">
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
  											...
  											<div class="col-md-12">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> SORTIES</div>
											  <div class="panel-body">
												    ...
												    <tbody>
												    	<?php
															...
															$fetch_branche=$out_branche->fetch();
													    		?>
												      <tr>
												      	<td> <a href="bilan_sorties.php?bid=<?php echo $fetch_branche['bid'];?>"> <?php echo $fetch_branche['branche'];?> </td>
												        </tr>
												        <?php 
													  	} 
													 ?>
