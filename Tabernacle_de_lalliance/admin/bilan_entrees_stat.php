...
$out_offrande_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where evenement='$culte' and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and branche='$bid' order BY date desc;
          ...
          <div class="col-md-12">
                ...
                <br/>
					...
					<div class="panel panel-default" >
                      ...
                      <input type="hidden" id="title" value="STATISTIQUES DES OFFRANDES - <?php echo strtoupper($fetch_offrande_info['evenement']); ?> <br/><br/><br/>" > 
...
$out_offrande=$con->query("select * from (select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where evenement='$culte' and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and branche='$bid' ORDER BY date desc limit 6) as tab order by tab.year, tab.month asc;") or die (print_r($con->errorInfo()));
...
$out_offrande_c_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and year(date)='$yearc' and month(date)='$monthc' and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin'  and branche='$bid';") or die (print_r($con->errorInfo()));
    ...
    <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                $out_offrande_fiche_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and year(date)='$year' and month(date)='$month' and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin'  and branche='$bid';
                                ") or die (print_r($con->errorInfo()));
