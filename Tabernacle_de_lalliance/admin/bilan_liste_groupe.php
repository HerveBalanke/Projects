          	...
          	<ul  class="nav nav-tabs">
                ...
                <br/>
								...
								<div class="panel panel-default">
  										...
  										<!-- <a href='bilan_groupe.php'id='retour' style="color:rgb(255, 213, 29);" title="Retournez a la liste des Groupes" class="pull-right"> <b> Retour </b> </a> -->
  										</div>
    									...
    									<input type="hidden" id="title" value="LISTE DES MEMBRES - <?php echo $groupe_out['groupe']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Leader: ".$groupe_out['nom']." ".$groupe_out['prenom']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nombre de Membres: ".$fetch_nom['nombre']; ?> <br/><br/><br/>" > 
											  <div class="panel-body" >	
