...
$soid=$_GET['soid'];
$out_sor=$con->query("select * from depense where did='$soid';") or die (print_r($con->errorInfo()));
          ...
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> SORTIES </b> 
  											...
  											<!-- <a href='gerer_sorties.php'id='retour' style="color:rgb(255, 213, 29);" title="Retournez vers la Page principale des Sorties" class="pull-right"> <b> Retour </b> </a> -->
  										</div>
  										<div class="panel-body">
											  ...
											  <input type="hidden" id="title" value="DETAILS DE LA SORTIE <br/><br/><br/>" >
											  <div class="panel-body">
											  	<div class="row">
         										<div class="col-md-10">
         										<div id="flash"></div>
         											<table class="table table-bordered" id="tabone">
												    <tbody>
												      <tr>
												      	<th>Date</th>
