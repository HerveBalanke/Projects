...
$count_groupe=$con->query("select count(gid) as grp from groupe where branche='$bid' ;") or die (print_r($con->errorInfo()));
$count_groupe_num=$count_groupe->fetch();
$out_groupe=$con->query("select * from groupe
inner join membre on groupe.leader=membre.mid  where groupe.branche='$bid' order by groupe.gid desc;
          ...
          <div class="col-md-12">
                ...
                <br/>
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> RAPPORT DES GROUPES - Nombres de groupes: <?php echo $count_groupe; ?></b> </div>
  										<input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
    									<input type="hidden" id="title" value="RAPPORT DES GROUPES - Nombres de groupes: <?php echo $count_groupe; ?> <br/><br/><br/>" > 
												    ...
												    <tbody>
												    	<?php
															...
															$fetch_groupe=$out_groupe->fetch();
													    		?>
												      <tr>
												        <td class="text-center"><a href="bilan_liste_groupe.php?groupe=<?php echo $fetch_groupe['gid'];?>"><?php echo $fetch_groupe['groupe'];?></a></td>
