...
$out_sorties=$con->query("select * from depense where administrateur='oui' and admin_id='$admin' and branche ='$bid';
									...
									<br/>
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
  											...
  											<div class="col-md-12">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> TRANSACTIONS EFFECTUEES - DEPENSES</div>
											  <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
											  <input type="hidden" id="title" value="TRANSACTIONS EFFECTUEES - DEPENSES <br/><br/><br/>" >
											  <div class="panel-body">
