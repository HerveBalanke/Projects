...
$mem_fem=$con->query("select * from membre where genre='F' and branche='$bid';") or die (print_r($con->errorInfo()));
$count_membre=$mem_fem->rowCount();
?>
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> MEMBRES FEMININ </b>
  											<input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
  											<input type="hidden" id="title" value="MEMBRES FEMININ <br/><br/><br/>" >
  										...
  										<div class="panel-body">
									    	...
									    	for($i=0; $i<$count_membre; $i++){
									    		$fetch_mem_fem=$mem_fem->fetch();
									    		?>
												      <tr>
												        <td><a href="view_membre.php?mid=<?php echo $fetch_mem_fem['mid']?>"><?php echo $fetch_mem_fem['nom']?></td>
												        <td><?php echo $fetch_mem_fem['prenom']?> </td>
												      </tr>
												      <?php
														}
												      ?>
