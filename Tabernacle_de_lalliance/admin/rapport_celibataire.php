...
$mem_cel=$con->query("select * from membre where sit_mat='Celibataire' and branche='$bid';") or die (print_r($con->errorInfo()));
$count_membre=$mem_cel->rowCount();
?>	
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> MEMBRES CELIBATAIRES </b> 
  											<input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
  											<input type="hidden" id="title" value="MEMBRES CELIBATAIRES <br/><br/><br/>" >
  										...
  										<div class="panel-body">
									    	...
									    	for($i=0; $i<$count_membre; $i++){
									    		$fetch_mem_cel=$mem_cel->fetch();
									    		?>
												      <tr>
												        <td><a href="view_membre.php?mid=<?php echo $fetch_mem_cel['mid']?>"><?php echo $fetch_mem_cel['nom']?></td>
												        <td><?php echo $fetch_mem_cel['prenom']?> </td>
												      </tr>
												      <?php
														}
												      ?>
