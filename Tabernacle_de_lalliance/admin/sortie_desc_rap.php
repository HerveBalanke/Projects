...
$soid=$_GET['soid'];
$date=$_GET['date'];
$out_sor=$con->query("select * from depense where tresorier!='-' and administrateur='oui' and admin_id='$admin' and did='$soid' and branche='$bid';") or die (print_r($con->errorInfo()));
