...
inner join membre on dime.membre=membre.mid where YEAR(dime.date) = '$year' AND MONTH(dime.date) = '$month' and
 tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin'  and dime.branche='$bid' order by dime.date desc;
...
inner join membre on dime.membre=membre.mid where  YEAR(dime.date) = '$year' AND MONTH(dime.date) = '$month' 
and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and dime.branche='$bid';
") or die (print_r($con->errorInfo()));
    ...
    <div class="section">
     ...
     <div class="section">
      <div class="container">
            ...
            <ul  class="nav nav-tabs">
                  ...
                  <li>
					...
					<div class="panel panel-default">
                     ...
                     <!-- <a href='rapport_dime.php'id='retour' style="color:rgb(255, 213, 29);" title="Retournez vers l'histogramme" class="pull-right"> <b> Retour </b> </a> -->
                      </div>
        ...
        <div class="col-sm-10">
    <div class="panel panel-default">
    <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> FICHE DES DIMES </b> </div>
    <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
    <input type="hidden" id="title" value="FICHE DES DIMES <br/><br/><br/>" > 
    <div class="panel-body">
