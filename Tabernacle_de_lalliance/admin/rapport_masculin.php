...
$mem_max=$con->query("select * from membre where genre='M' and branche='$bid';") or die (print_r($con->errorInfo()));
$count_membre=$mem_max->rowCount();
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> MEMBRES MASCULIN </b> 
  											<input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
  											<input type="hidden" id="title" value="MEMBRES MASCULIN <br/><br/><br/>" >
  										...
  										<div class="panel-body">
									    	...
									    	for($i=0; $i<$count_membre; $i++){
									    		$fetch_mem_max=$mem_max->fetch();
									    		?>
												      <tr>
												        <td><a href="view_membre.php?mid=<?php echo $fetch_mem_max['mid']?>"><?php echo $fetch_mem_max['nom']?></td>
												        <td><?php echo $fetch_mem_max['prenom']?> </td>
												      </tr>
												      <?php
														}
												      ?>
