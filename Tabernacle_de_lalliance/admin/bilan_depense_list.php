...
$out_depense_fiche=$con->query("select * from depense where YEAR(date)='$year' and MONTH(date)='$month' and tresorier!='-' and administrateur='oui' and admin_id='$admin' and branche='$bid' order by did desc;") or die (print_r($con->errorInfo()));
$count_depense_fiche=$out_depense_fiche->rowCount();

$out_depense_sum=$con->query("select sum(montant) as sum from depense where YEAR(date)='$year' and MONTH(date)='$month' and tresorier!='-' and administrateur='oui' and admin_id='$admin' and branche='$bid';") or die (print_r($con->errorInfo()));
