...
<html>
	...
	bootbox.alert("<strong>L'utilisateur a été ajouté avec success! Mais, le SMS n'a pas été envoyé, veuillez vérifier le numero de tel du destinataire, la connection internet et le compte SMS</strong>", function(result) { 
    window.location.href ='ajouter_utilisateur.php';
	});
		}
			}
