	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$out_ni=$con->query("select * from niveau where niveau.niid not in (6, 4, 3);") or die (print_r($con->errorInfo()));
									...
									<li><a href="utilisateur_out.php" >LISTE DES UTILISATEURS</a>
										...
										<br/>
										  	...
										  	<div class="panel panel-default">
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>AJOUTER UN UTILISATEUR </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form" action="gerer_utilisateur.php" multipart/form-data role="form">
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" >Adresse(s) Electronique(s) <span style="color:red;">*</span></label>
														    <div class="col-sm-8">
														    ...
														    <br/>
														      <input type="text" class="form-control" id="facebook" style="text-transform: capitalize;" placeholder="Entrez Pseudo Facebook" maxlength="50">
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2">Contact(s) Telephonique(s) <span style="color:red;">*</span></label>
														    <div class="col-sm-10"> 
										...
										<div id='check_b' style="color:red"></div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="ni">Responsabilité <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
																  <select class="form-control" id="ni">

																  	<option>--- Choisissez une Responsabilité ---</option>
...
var dataString = "nom="+ nom +"&prenom="+ prenom +"&genre="+ genre +"&date="+ date +"&pays="+ pays +
 "&prof="+ prof + "&lha="+ lha +"&mail="+ mail+"&fac="+ fac + "&codet="+ a +"&tel="+ tel+ "&codew="+ b + "&whatsapp="+ whatsapp +"&ni="+ ni + "&bid=" + bid+
 "&prof_alt="+ prof_alt;
...
$.ajax({
type: "POST",
url: "ajouter_utilisateur_eng.php",
data:dataString,
cache:true,
processData:false,
success: function(out){
	...
	$('#form').clearForm();
	$('#lod').hide();
	bootbox.alert("<strong>Données de l'utilisateur enregistrées!</strong>", function(result) { 
	window.location.href ='utilisateur_photo.php?uid='+txt[1];
	});
