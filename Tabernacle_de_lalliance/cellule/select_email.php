...
$out_membre=$con->query("select * from membre_cel inner join cellule on membre_cel.cellule=cellule.cid and zone_cel='$zone_cel';") or die (print_r($con->errorInfo()));
...
<html>
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> Selectionnez les emails </b> 
  											<!-- <a href="email.php?head=<?php //echo $head; ?>&mess=<?php //echo $mess; ?>&cel=<?php //echo $cel ?>" style="color:rgb(255, 213, 29);" title="Retour vers la page précédente" class="pull-right"> <b> <<< Revenir</b> </a> -->
  										</div>
									  ...
									  <table class="table table-striped table-condensed table-hover" id='tab'>
									  	<input type="hidden" class="form-control" value="<?php echo $zone;?>" id="zone">
  ...
  return this.each(function() {
	...
	var choix = [];
           ...
           var dataString = "mess="+ mess+ "&head="+ head + "&choix="+ choix+ "&zone="+zone;
