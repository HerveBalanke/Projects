...
<html>
	...
	<head>
            ...
            $lid=$_GET["lid"]; 
            $lead_det=$con->query("select * from leader where lid='$lid';") or die(print_r($con->errorInfo()));
        ...
        <div class="col-md-3"></div>
          <div class="col-md-6">
         	...
         	<form role="form" id="form" method="POST" action="ajouter_porteur.php">
              <div id="flash"></div>
                <input type="hidden" class="form-control" id="lid" value="<?php  echo $fetch_lead["lid"]; ?>">
                <div class="form-group">
                  <label for="nom">Nom:</label>
                  <input type="text" class="form-control" id="nom" value="<?php  echo $fetch_lead["nom"]; ?>" style="text-transform: capitalize;" placeholder="Entrez Nom" maxlength="30">
                  <div id='check_nom' style="color:red"></div>
                </div>
                <div class="form-group">
                  <label for="prenom">Prenom:</label>
                  <input type="text" class="form-control" id="prenom" value="<?php  echo $fetch_lead["prenom"]; ?>" style="text-transform: capitalize;" placeholder="Entrez Prenom" maxlength="30">
    ...
    $("#nom").focus();
            ...
            $('#lod').hide();
              ...
              var emailRegex = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
                    ...
                    var dataString ="lid=" + lid + "&nom="+ nom + "&prenom=" + prenom + "&tel=" + tel + "&email=" + email + "&branche=" + branche;
                    alert(dataString);
                    $('#lod').show();
                    $.ajax({
                    type: "POST",
