...
and presence.reunion='$rid' and statut='a';") or die (print_r($con->errorInfo()));
			  	...
			  	<div class="table-responsive">
				    ...
				    <tbody>
				      ...
				      <tr>
				        ...
				        ?>
				        <a href="javascript: elver_abs('<?php echo $fetch_membre_cel['mcid']; ?>', '<?php echo $rid; ?>')" title="Enlever" ><button type="button" class="btn btn-danger">Enlever</button></a>
					  		<?php
					  			}
					  		?>
					  </td>
