...
$out_mem=$con->query("select * from membre_cel inner join cellule on membre_cel.cellule=cellule.cid and zone_cel='$zone_cel';") or die (print_r($con->errorInfo()));
										...
										<br/>
  										...
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> Email </b> </div>
         										...
         										<form class="form"  method="POST" id="form" action="email.php" multipart/form-data role="form">
														<input type="hidden" class="form-control" id="zone" value="<?php echo $zone_cel; ?>" >
												...
												<div class="form-group">
														    <label class="control-label col-sm-2" for="email">Adresse:</label>
																  <select class="form-control" id="email">
																    ...
																    <?php echo $fetch_mem ["nom"]." ".$fetch_mem ["prenom"]." - ".$fetch_mem ["email"] ;?>
...
window.location.href ='select_email.php?mess='+ mess+'&head='+head+'&zone='+zone;
}
...
var dataString = "email="+ email + "&head="+ head+ "&mess="+ mess+ '&zone='+zone;
