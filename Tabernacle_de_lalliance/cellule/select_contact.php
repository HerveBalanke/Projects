...
$sms=$_GET["sms"];
$zone=$_GET["zone"];
$out_mem=$con->query("select * from membre_cel inner join cellule on membre_cel.cellule=cellule.cid and zone_cel='$zone';") or die (print_r($con->errorInfo()));
        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										...
  										<!-- <a href="communication.php?sms=<?php// echo $sms; ?>&zone=<?php //echo $zone ?>" style="color:rgb(255, 213, 29);" title="Retour vers la page précédente" class="pull-right"> <b> <<< Revenir</b> </a> -->
    ...
    if (type == 'text' || type == 'password' || tag == 'textarea' || type == 'number' || type == 'email')
      ...
      this.selectedIndex = 0;
		...
		$("#submit").click(function() {
            ...
            var dataString = "sms="+ sms+ "&choix="+ choix+ "&zone"+zone;
