...
$groupe_out=$con->query("select * from groupe
	inner join membre on groupe.leader=membre.mid where groupe.gid='$groupe' and groupe.branche='$bid';")or die (print_r($con->errorInfo()));
...
$mem_nom=$con->query("select count(membre) as nombre from grou_mem inner join groupe on groupe.gid=grou_mem.gid
	where groupe.gid='$groupe' and groupe.branche='$bid';")or die (print_r($con->errorInfo()));
								...
								<div class="panel panel-default">
  										...
  										<div class="panel-body">
												...
												<div class="form-group">
														  ...
														  <div class="form-group"> 
														    <div class="col-sm-offset-2 col-sm-10">
														      ...
														      <a href="ajout_multiple_groupe.php?groupe=<?php echo $groupe; ?>" title="Ajout Multiple">Ajout Multiple</a>
														    </div>
														  </div>
											...
											<div class="panel panel-default" >
											  ...
											  <?php include("liste_membre_groupe.php"); ?>								  	
											 </div>									  	
											 </div>
											</div>
											<div class="col-md-1"></div>
	...
	<script type="text/javascript">
						...
						if(result)
						{
							...
							success: function(result){
								{
								if (result=="OK"){
								$('#liste').load('liste_membre_groupe.php?groupe='+gid);
...
success: function(result){
	...
	$('#liste').load('liste_membre_groupe.php?groupe='+groupe);
		}else if(result=="NO"){
