	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$out_sta=$con->query("select * from t_membre;") or die (print_r($con->errorInfo()));
		   			$count_sta=$out_sta->rowCount();
		   			?>
						...
						<ul  class="nav nav-tabs">
									...
									<li><a href="membre_out.php" >LISTE DES MEMBRES</a>
										  	...
										  	<div class="panel panel-default">
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>FICHE DE RENSEIGNEMENT </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form_membre" action="ajouter_membre.php" multipart/form-data role="form">
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="genre">Genre <span style="color:red;">*</span></label>
														    <div class="col-sm-8"> 
														     <div class="radio">
															  <label><input type="radio" id="genre" name="genre" value="M">Masculin</label>
															</div>
															<div class="radio">
															  <label><input type="radio" id="genre" name="genre" value="F">Feminin</label>
															</div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="dob">Date de Naissance <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="pays">Pays d'Origine <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
														      <div class="bfh-selectbox bfh-countries" id="pays" data-country="GH" data-flags="true">
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="prof">Profession <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-8"> 
																  <select class="form-control" id="ecole">
																  	<option>--- Choisir une Ecole/Université ---</option>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="sim">Situation Matrimoniale <span style="color:red;">*</span></label>
														    <div class="col-sm-10"> 
														      <div class="radio">
															  <label><input type="radio" id="sim" name="sim" value="Marie(e)">Marié(e)</label>
															</div>
															<div class="radio">
															  <label><input type="radio" id="sim" name="sim" value="Celibataire">Célibataire</label>
															</div>
															<div class="radio">
															  <label><input type="radio" id="sim" name="sim" value="Fiance(e)">Fiancé(e)</label>
															</div>
															<div class="radio">
															  <label><input type="radio" id="sim" name="sim" value="Engage(e)">Engagé(e)</label>
															</div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="ne">Nombre d'Enfant <span style="color:red;">*</span></label>
														    <div class="col-sm-2"> 
														      <input type="number" class="form-control" id="ne" min="0"  onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" maxlength="5">
														      <div id='check_ne' style="color:red"></div>
														    </div>
														  </div>

														  <div class="form-group">
														    <label class="control-label col-sm-2" for="lha">Lieu d'Habitation <span style="color:red;">*</span></label>
														    <div class="col-sm-8"> 
														      <input type="text" class="form-control" id="lha" style="text-transform: capitalize;" placeholder="Entrez le Lieu d'Habitation" maxlength="30">
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-8">
														      <input type="email" class="form-control" id="mail"  placeholder="Entrez L'address e-mail" maxlength="50">
														      <div id='check_mail' style="color:red"></div>
														    <br/>
														      <input type="text" class="form-control" id="facebook" style="text-transform: capitalize;" placeholder="Entrez Pseudo Facebook" maxlength="30">
										...
										<div id='check_b' style="color:red"></div>
														      ...
														      <div class='form-group'>
														      	<input type="telephone" class="form-control" id="whatsapp" placeholder="Entrez le N° Whatsapp" maxlength="10">
														  ...
														  <label style="color:rgb(130, 0, 31);" >B.	INFORMATION SUR LE PLAN SPIRITUEL</label> <br/><br/>

														  <div class="form-group">
														    <label class="control-label col-sm-5" for="temps">Depuis combien de temps aviez-vous accepté Jésus dans votre vie? <span style="color:red;">*</span></label>
														    <div class="col-sm-5">
														      <input type="text" class="form-control col-sm-2" id="temps" style="text-transform: capitalize;" maxlength="30">
														      <div id='check_temps' style="color:red"></div>
														    </div>
														  </div>

														  <div class="form-group">
														    <label class="control-label col-sm-5" for="ae">Quelle église fréquentiez-vous auparavant? <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
																  <select class="form-control" id="ae">
																  	<option>--- Choisir une Eglise ---</option>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-5" for="bpt">Avez-vous été déjà baptisé par immersion? <span style="color:red;">*</span></label>
														    <div class="col-sm-4"> 
														     <div class="radio">
															  <label><input type="radio" id="bpt" name="bpt" value="o">Oui</label>
															</div>
															<div class="radio">
															  <label><input type="radio" id="bpt" name="bpt" value="n">Non</label>
															</div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-5" for="ac">Quelle activité faisiez-vous dans votre ancienne église? <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-8">
														      <input type="text" class="form-control" id="nom_ur" style="text-transform: capitalize;" placeholder="Entrez le(s) Nom(s)" maxlength="30">
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-8"> 
														      <input type="text" class="form-control" id="prenom_ur" style="text-transform: capitalize;" placeholder="Entrez le(s) Prenom(s)" maxlength="50">
										...
										<div id='check_a_ur' style="color:red"></div>
														      ...
														      <div class='form-group'>
														      	<input type="telephone" class="form-control" id="tel_ur" placeholder="Entrez le N° de Telephone" maxlength="10">
														    ...
														    <div class="col-sm-8">
														      <input type="email" class="form-control" id="mail_ur"  placeholder="Entrez L'address e-mail" maxlength="50">
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-6"> 
																  <select class="form-control" id="rel">
																  	...
																  	<option>--- Choisir une Relation ---</option>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="da" style="color:rgb(130, 0, 31);">Date d'Adhésion <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
														     <div class="bfh-datepicker" data-format="y-m-d" data-date="today" id="da">
															  <div class="input-prepend bfh-datepicker-toggle" data-toggle="bfh-datepicker">
															    <span class="add-on"><i class="icon-calendar"></i></span>
    ...
    if (type == 'text' || type == 'password' || tag == 'textarea' || type == 'number' || type == 'email')
      ...
      this.selectedIndex = 0;
	 	...
	 	$("#submit").click(function() {
			...
			var ae= $("#ae").val();
			var ae_alt= $("#ae_alt").val();
			var bpt=$('input[name="bpt"]:checked').val();
			var ac= $("#ac").val();
			var ac_alt= $("#ac_alt").val();
			var ac_ta= $("#ac_ta").val();
			var ac_ta_alt= $("#ac_ta_alt").val();
...
$('#check_pays').html("*Selectionnez un <strong>Pays</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#pays").focus(); 
...
$("#facebook").change(function(){ $('#check_fac').hide();
});
return false;
}
...
// else if (sta.length == 0 || sta=="--- Choisir un Statut ---" || sta=="Autre") {
// $('#check_sta').html("*Selectionnez un <strong>Statut</strong>").show(); // This Segment Displays The Validation Rule For All Fields
// $("#sta").focus(); 

// $("#sta").change(function(){ $('#check_sta').hide();
// });
// return false;
// }
...
else if (mail_ur.length == 0) {
$('#check_mail_ur').html("*Entrez un addresse <strong>Email Valide</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#mail_ur").focus(); 
...
var dataString ="bid="+ bid +"&nom="+ nom +"&prenom="+ prenom +"&genre="+ genre +"&date="+ date +"&pays="+ pays + "&prof="+ prof +"&fil="+ fil+
"&ecole="+ ecole +"&sim="+ sim +"&ne="+ ne + "&lha="+ lha +"&mail="+ mail+"&fac="+ fac + "&codetel="+ a + "&tel="+ tel+ "&codewhat="+ b + "&whatsapp="+ whatsapp +"&temps="+ temps+
"&ae="+ ae +"&bpt="+ bpt +"&ac="+ ac + "&ac_ta="+ ac_ta + "&nom_ur="+ nom_ur +"&prenom_ur="+ prenom_ur +"&code_ur="+a_ur+ "&tel_ur="+ tel_ur +"&mail_ur="+ mail_ur +"&rel="+ rel +"&prof_alt="+ prof_alt +"&fil_alt=" + fil_alt+ 
"&ecole_alt=" + ecole_alt+ "&ae_alt=" + ae_alt +"&ac_alt=" + ac_alt + "&ac_ta_alt=" + ac_ta_alt +"&rel_alt=" + rel_alt+ "&da=" + da;
...
success: function(result){
	...
	window.location.href ='membre_photo.php?id='+txt[1];
	});
	
	} else if (txt[0]=="SENTN"){
	$('#form_membre').clearForm();
	$('#lod').hide();
	bootbox.alert("<strong>Données du membre enregistrées! Mais, le SMS n'a pas été envoyé, veuillez vérifier le numero de tel du destinataire, la connection internet et le compte SMS</strong>", function(result) { 
	window.location.href ='membre_photo.php?id='+txt[1];
	});
	...
	// else if (txt[0]=="NO_sta"){
	// $('#lod').hide();
	// bootbox.alert("<strong>Ce Statut a deja été enregistré, veuillez le selectionner dans la liste déroulante</strong>", function(result) { 
	// $("#sta").focus();
	// $('#check_sta').html("*Choisissez ce statut dans <strong>la liste déroulante</strong>").show();
	// });
	// $("#sta").change(function(){ $('#check_sta').hide();
	// });
