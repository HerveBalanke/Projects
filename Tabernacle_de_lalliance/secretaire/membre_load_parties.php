...
inner join t_membre on membre.t_membre=t_membre.tmid where branche='$bid' and statut='partie';") or die (print_r($con->errorInfo()));
...
<html>
	...
	<body>
									<div class="panel-body">
									  ...
									  <table class="table table-striped table-condensed table-hover" id="tab_parties">
									    <thead>
									      <tr>
									    ...
									    <tbody>
									      ...
									      <tr>
									        ...
									        <td class="text-center" style="vertical-align:middle"><a href="javascript:sup_par_id(<?php echo $fetch_mem['id']; ?>)" > <span style="color:red; " class="glyphicon glyphicon-trash"></span></a></td>
									        <td class="text-center" style="vertical-align:middle"><a href="javascript:statut_re_id(<?php echo $fetch_mem['id']; ?>)" > <button type="button" class="btn btn-danger">Retour?</button></a></td>
									      </tr>
