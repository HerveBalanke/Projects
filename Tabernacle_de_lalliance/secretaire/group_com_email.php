												    ...
												    <tbody>
												    	<?php
															...
															$fetch_groupe=$out_groupe->fetch();
													    		?>
												      <tr>
												        <td class="text-center"><a href="email_groupe_send.php?groupe=<?php echo $fetch_groupe['gid'];?>& mess=<?php echo $mess;?>& head=<?php echo $head;?>"><?php echo $fetch_groupe['groupe'];?></a></td>
