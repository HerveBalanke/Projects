          ...
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										...
  										<div class="panel-body">
  											...
  											<div class="col-md-6">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">FAITES UNE SORTIE</div>
											  <div class="panel-body">
											  	<div class="row">
         										...
         										<form class="form-horizontal"  method="POST" id="form_entree" action="gerer_sorties.php" multipart/form-data role="form">
											  	...
											  	<div class="form-group">
													...
													<div class="form-group">
														    ...
														    <div class="col-sm-9">
														    <textarea class="form-control" rows="5" id="desc" maxlength="225"></textarea>
											...
											<a href="entrees_personnelles_sorties.php"><button type="button" class="btn btn-info">Liste des Sorties Effectuées</button> </a>
											</div>

											<div class="col-md-6">
											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">SORTIES DES MOIS </div>
											...
											<div class="row">
  											...
  											<div class="col-md-8">
												<br/>
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">SORTIES RECENTES</div>
