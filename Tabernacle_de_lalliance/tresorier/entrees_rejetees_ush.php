										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
											...
											<div class="row">
  											...
  											<div class="col-md-10">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">ENTREES A VERIFIER</div>
											  <div class="panel-body" id="ent_val">
											  	<?php include_once('entrees_rejetees_liste_ush.php'); ?>
												  </div>
											</div>
  											</div>
  											<div class="col-md-1"></div>
	...
	<script src="../data_table/media/js/jquery.dataTables.min.js"></script>
	 ...
	 <script type="text/javascript">
						...
						if(result)
						{
							$.ajax({
							type: "POST",
							url: "supprimer_offrande_rej.php",
							data: info,
							cache:true,
							processData:false,
							success: function(response){
								{
								if(response=="OK"){
								$('#ent_val').load("entrees_rejetees_liste_ush.php");
