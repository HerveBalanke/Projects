...
inner join membre on dime.membre=membre.mid where tresorier='$treso' and dime.branche='$bid' order by dime.diid desc;
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
											...
											<div class="row">
  											...
  											<div class="col-md-10">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> DIMES ENTREES</div>
											  <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
											  <input type="hidden" id="title" value="DIMES ENTREES <br/><br/><br/>" >
											  <div class="panel-body">
