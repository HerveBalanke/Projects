<?php
					...
					$bid=$_SESSION['bid'];				
		   			...
		   			$update_offrande=$con->prepare("update offrande set date=?, recette=?, evenement=?, usher=?, usher_id=?, admin=?, admin_id=?, branche=? where oid=? and tresorier=?;") or (print_r($con->errorInfo()));
