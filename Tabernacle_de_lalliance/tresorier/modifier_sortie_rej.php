...
$soid=$_GET['soid'];
$out_sor=$con->query("select * from depense where did='$soid' and tresorier='$treso' and administrateur='non' and branche ='$bid';") or die (print_r($con->errorInfo()));
...
var dataString = "tid="+ tid+ "&soid="+soid +"&date="+ date + "&desc="+ desc +"&motif="+ motif +"&mon="+ mon ;
