...
$out_dim=$con->query("select * from dime where diid='$did' and tresorier='$treso' and usher='-' and admin='-' and branche='$bid';") or die (print_r($con->errorInfo()));
...
$("#mid").change(function(){ $('#check_id').hide();
});
return false;
}
