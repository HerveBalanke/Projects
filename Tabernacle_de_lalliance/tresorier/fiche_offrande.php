...
and tresorier='$treso' and admin='oui' and offrande.branche='$bid' order by offrande.date desc;
...
inner join evenement on offrande.evenement=evenement.eid where offrande.evenement='$culte' and YEAR(offrande.date) = '$year' AND MONTH(offrande.date) = '$month' 
and tresorier='$treso' and admin='oui'  and offrande.branche='$bid'
") or die (print_r($con->errorInfo()));
          ...
          <div class="col-md-12">
                ...
                <li ><a href="dimes_entree.php" >DIMES</a></li>
					...
					<div class="panel panel-default">
                     ...
                     <!-- <a href='offrande_stat.php?culte=<?php //echo $culte;?>'id='retour' style="color:rgb(255, 213, 29);" title="Retournez à la liste des mois" class="pull-right"> <b> Retour </b> </a> -->
                      </div>
