...
inner join evenement on offrande.evenement=evenement.eid where tresorier='$treso' and offrande.branche='$bid' order by offrande.oid desc;
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
											...
											<div class="row">
  											...
  											<div class="col-md-10">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">OFFRANDES ENTREES</div>
											  <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
											  <input type="hidden" id="title" value="OFFRANDES ENTREES <br/><br/><br/>" >
											  <div class="panel-body">
