...
$out_offrande_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where tresorier='$treso' 
 and admin='oui' and evenement='$culte' and  branche='$bid' ORDER BY date desc; ") or die (print_r($con->errorInfo()));
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
                ...
                <li ><a href="dimes_entree.php" >DIMES</a> </li>
								</ul>	
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                $out_offrande_fiche_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and branche='$bid' and year(date)='$year' and month(date)='$month' 
                                  and tresorier='$treso' and admin='oui'  and  branche='$bid';
