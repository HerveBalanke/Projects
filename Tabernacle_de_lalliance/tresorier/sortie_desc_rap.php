...
$soid=$_GET['soid'];
$date=$_GET['date'];
$out_sor=$con->query("select * from depense where did='$soid' and tresorier='$treso' and administrateur!='-' and administrateur!='non' and branche='$bid';") or die (print_r($con->errorInfo()));
        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> RAPPORTS DES SORTIES </b>
  											<!-- <a href='depenses_stat.php?soid=<?php// echo $soid ;?>&date=<?php //echo $date; ?>' id='retour' style="color:rgb(255, 213, 29);" title="Retournez à la Page des Sorties" class="pull-right"> <b> Retour </b> </a> -->
  										 </div>
