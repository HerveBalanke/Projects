	...
	inner join membre on dime.membre=membre.mid where tresorier='$treso' and (usher='non' or admin='non') and dime.branche='$bid' ORDER BY date desc;
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> DIMES </b>
  											<?php 
  											if($count_dime_ush>0){ ?>
  										<a href='dime_rejetees_ush.php' style="color:rgb(255, 213, 29);" title="Vérifier les entrées" class="pull-right"> <b> Entrées à vérifier </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_dime_ush ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
  										</div>
  										<div class="panel-body">
											...
											<a href='entrees_dimes_personnelles.php'><button type="button"  class="btn btn-info">Liste des Dimes Entrées</button> </a> 
											</div>
											<div class="col-md-6">
											<div class="panel panel-default">
...
$('#check_montant').html("*Entrez Le <strong>Montant</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#montant").focus(); 
