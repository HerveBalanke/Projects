<?php
		   			...
		   			$update_offrande=$con->prepare("update offrande set date=?, recette=?, evenement=? where oid=?;") or (print_r($con->errorInfo()));
		   			$update_offrande->execute(array($date, $rec, $culte, $oid)) or (print_r($con->errorInfo()));
