				  ...
				  <div class="container-fluid" id="nv">
				    ...
				    <div class="collapse navbar-collapse">
				      <ul class="nav navbar-nav" id="navbar" >
					      <li><a href="copy.php">Gerer Membre</a></li>
					      <li><a href="copy_deux.php">Gerer Entrées</a></li>
										...
										<br/>
										  	...
										  	<div class="panel panel-default">
												 ...
												 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															  ...
															  <div>
															    <span class="btn btn-default btn-file"><span class="fileinput-new">Choisissez une Photo</span><span class="fileinput-exists">Changez</span><input type="file" id="photo" name="photo" ></span>
    			...
    			<div class="navbar-header"> 
    				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-ex-collapse">
    					...
    					<div class="collapse navbar-collapse" id="navbar-ex-collapse"> 
    						<ul class="nav navbar-nav navbar-right"> <li class="active"> <a href="#">Home</a> </li><li> <a href="#">Contacts</a> </li></ul>
    						 </div></div></div>
    						 <div class="cover-image"></div>
    						 <div class="container"> 
    						 	<div class="row"> 
    						 	<div class="col-md-12 text-center"> <h1>Heading</h1> <p>Lorem ipsum dolor sit amet, consectetur adipisici eli.</p><br><br><a class="btn btn-lg btn-default">Click me</a> </div></div></div></div>
