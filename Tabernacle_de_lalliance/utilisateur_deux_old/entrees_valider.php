...
<html>
	...
	<head>
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			inner join evenement on offrande.evenement=evenement.eid where signataire_un='1' and signataire_deux='' order by offrande.oid desc;
	...
	<body>
											  	...
											  	<div class="table-responsive">
												    ...
												    <tbody>
												      ...
												      <td class="text-center" style="vertical-align:middle"><a href="javascript:sup_vid(<?php echo $fetch_offrande['oid']; ?>)" title="Valider l'entrée" style="color:red; " ><button type="button" id="valider" name="valider" class="btn btn-success">Valider</button></a></td>
