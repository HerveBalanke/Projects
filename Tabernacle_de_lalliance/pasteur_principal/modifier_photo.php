...
$id=$_GET["uid"];
$query=$con->query("select photo from utilisateur where uid='$id';") or die (print_r($con->errorInfo()));
												 ...
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>CHANGER LA PHOTO </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form" name="form" action="ajaxupload_update.php" multipart/form-data role="form">
         												 ...
         												 <div class="col-md-4">
         												 	<input type="hidden" class="form-control" id="id" name="uid"  value="<?php echo $id ;?>"  maxlength="10">
 ...
 $("#form").on('submit',(function(e) {
  ...
  $.ajax({
   ...
   success: function(data)
    ...
    window.location.href ='utilisateur_view_branche.php?'+dataString;
	});
