...
<html>
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
           ...
           $out_dime_fiche=$con->query("select * from dime
            inner join membre on dime.membre=membre.mid where dime.membre='$mid' and YEAR(dime.date) = '$year' AND MONTH(dime.date) = '$month' order by dime.date desc;
           ...
           $out_dime_fiche_sum=$con->query("select sum(montant) as sum from dime
            inner join membre on dime.membre=membre.mid where dime.membre='$mid' and YEAR(dime.date) = '$year' AND MONTH(dime.date) = '$month';
              ") or die (print_r($con->errorInfo()));
           $fetch_sum= $out_dime_fiche_sum->fetch();

           $out_membre=$con->query("select * from membre where mid='$mid';") or die (print_r($con->errorInfo()));
    ...
    <div class="section">
     ...
     <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
					...
					<div class="panel panel-default">
                     ...
                     <a href='membre_dime.php?mid=<?php echo $mid;?>'id='retour' style="color:rgb(255, 213, 29);" title="Retournez vers l'histogramme" class="pull-right"> <b> Retour </b> </a>
                      </div>
        ...
        <div class="col-sm-10">
    <div class="panel panel-default">
    <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> FICHE DES DIMES - <?php echo strtoupper($fetch_membre['mid']); ?> - <?php echo strtoupper($fetch_membre['nom']); ?> - <?php echo strtoupper($fetch_membre['prenom']); ?> - <?php echo $date; ?> </b> </div>
    <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-center"><?php echo $fetch_dime_fiche['mid'];?></td>
