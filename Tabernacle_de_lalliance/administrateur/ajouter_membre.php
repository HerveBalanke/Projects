						...
						<ul  class="nav nav-tabs">
									...
									<li><a href="membre_out.php" >Liste des Membres</a>
												 ...
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>FICHE DE RENSEIGNEMENT </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form_membre" action="ajouter_membre.php" multipart/form-data role="form">
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="po">Pays d'Origine <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
										...
										<div id='check_b' style="color:red"></div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-5" for="sta">Statut du Membre <span style="color:red;">*</span></label>
														    <div class="col-sm-5"> 
																  <select class="form-control" id="sta">

																  	<option>--- Choisir un Statut---</option>

																	<?php
																	for($i=0; $i<$count_sta; $i++){
																		$fetch_sta=$out_sta->fetch();

																	?>
																    <option value= "<?php echo $fetch_sta ["tmid"];?>">
																    <?php echo $fetch_sta ["type"];?> 
																  ...
																  <div id="block_sta">
																  <br/>
																  <input type="text" class="form-control" id="sta_alt" style="text-transform: capitalize;" placeholder="Entrez le Statut" maxlength="50">
																  <div id='check_sta_alt' style="color:red"></div>
																  </div>
																  <div id='check_sta' style="color:red"></div>
														    </div>
														  </div>
...
"&ecole_alt=" + ecole_alt+ "&ae_alt=" + ae_alt +"&ac_alt=" + ac_alt +"&sta=" + sta + "&ac_ta_alt=" + ac_ta_alt + "&sta_alt=" + sta_alt +"&rel_alt=" + rel_alt+ "&da=" + da;
...
success: function(out){
	...
	window.location.href ='membre_photo.php?mid='+txt[1];
	});
