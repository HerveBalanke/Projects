...
// include_once("session_admin.php");
	...
	$count_rel=$out_rel->rowCount();
	 ...
	 inner join t_membre as mem on membre.t_membre=mem.tmid
												 ...
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>MODIFICATION DES DONNEES DU MEMBRE </b></div>
													...
													<div class="panel-body">
														...
														<div id="flash"> </div>
															...
															<input type="hidden" class="form-control" id="bid" value="<?php echo $fetch_out_membre['bid']; ?>" >
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-5"> 
																  <select class="form-control" id="sta">
																  	...
																  	<option value="<?php echo $fetch_out_membre['t_membre']; ?>" selected='selected'><?php echo $fetch_out_membre['type']; ?></option>
...
var dataString = "bid="+ bid + "&mid="+ mid + "&nom="+ nom +"&prenom="+ prenom +"&genre="+ genre +"&date="+ date +"&pays="+ pays + "&prof="+ prof +"&fil="+ fil+
...
"&ecole_alt=" + ecole_alt+ "&ae_alt=" + ae_alt +"&ac_alt=" + ac_alt +"&sta=" + sta +"&ac_ta_alt=" + ac_ta_alt + "&sta_alt=" + sta_alt+ "&rel_alt=" + rel_alt+ "&da=" + da + "&info_spi="+ info_spi + "&per_urgence=" + per_urgence; 
