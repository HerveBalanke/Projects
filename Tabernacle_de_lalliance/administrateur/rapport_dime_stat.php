...
<html>
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
            ...
            $out_dime_fiche=$con->query("select * from dime where YEAR(date)='$year' and MONTH(date)='$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL order by dime.diid desc;") or die (print_r($con->errorInfo()));
           $count_dime_fiche=$out_dime_fiche->rowCount();

           $out_dime_sum=$con->query("select sum(montant) as sum from dime where YEAR(date)='$year' and MONTH(date)='$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL;") or die (print_r($con->errorInfo()));
          ...
          <div class="col-md-12">
                  ...
                  <li class="active">
					...
					<div class="panel panel-default">
                        ...
                        <a href='dimes_entree.php' style="color:rgb(255, 213, 29);" title="Retour à la page principale" class="pull-right"> <b> Retour </b> </a> 
                      </div>
