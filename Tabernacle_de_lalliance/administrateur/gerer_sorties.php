	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$out_sorties=$con->query("select * from depense where signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois ='-';
          ...
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> SORTIES </b> 
  											<?php 
  											if($count_sorties>0){ ?>
  										<a href='sorties_confirmation.php' style="color:rgb(255, 213, 29);" title="Confirmer les sorties" class="pull-right"> <b> Sorties à confirmer </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_sorties ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
  										</div>
