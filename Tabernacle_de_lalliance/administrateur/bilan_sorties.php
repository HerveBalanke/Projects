	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
   			...
   			<script src="../3/js/themes/fusioncharts.theme.fint.js"></script>
		   			...
		   			$date_out=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM depense  where signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL ORDER BY date desc;") or die (print_r($con->errorInfo()));
...
$out_offrande=$con->query("select * from (select distinct extract(year from date) as year , extract(month from date) as month FROM depense where signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL ORDER BY date desc limit 6) as tab order by tab.year, tab.month asc;") or die (print_r($con->errorInfo()));
...
$out_offrande_c_sum=$con->query("select sum(montant) as sum FROM depense where year(date)='$yearc' and month(date)='$monthc' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL;") or die (print_r($con->errorInfo()));
    ...
    <div class="panel-body">
							...
							?>
                              <tr>
                                ...
                                $out_offrande_fiche_sum=$con->query("select sum(montant) as sum FROM depense where year(date)='$year' and month(date)='$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL;
