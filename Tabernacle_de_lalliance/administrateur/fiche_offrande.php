...
and tresorier='$treso' and usher is NULL and admin is NULL and offrande.branche='$bid' order by offrande.date desc;
...
inner join evenement on offrande.evenement=evenement.eid where offrande.evenement='$culte' and YEAR(offrande.date) = '$year' AND MONTH(offrande.date) = '$month' 
and tresorier='$treso' and usher is NULL and admin is NULL and offrande.branche='$bid'
") or die (print_r($con->errorInfo()));
