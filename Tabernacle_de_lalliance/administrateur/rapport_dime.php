...
$admin=$_SESSION['admin'];
 $out_dime_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM dime where 
  tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and branche='$bid' ORDER BY date desc;
...
$out_dime=$con->query("select * from (select distinct extract(year from date) as year , extract(month from date) as month FROM dime  where tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and branche='$bid' ORDER BY date desc limit 6) as tab order by tab.year, tab.month asc;") or die (print_r($con->errorInfo()));
...
$out_dime_c_sum=$con->query("select sum(montant) as sum FROM dime where year(date)='$yearc' and month(date)='$monthc' where tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and branche='$bid';") or die (print_r($con->errorInfo()));
    ...
    <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                $out_dime_fiche_sum=$con->query("select sum(montant) as sum FROM dime where year(date)='$year' and month(date)='$month' and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and branche='$bid'; ") or die (print_r($con->errorInfo()));
