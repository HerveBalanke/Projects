...
$out_offrande_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where tresorier='$treso' and 
usher is NULL and admin is NULL  and evenement='$culte' and  branche='$bid' ORDER BY date desc; ") or die (print_r($con->errorInfo()));
      ...
      <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              $date_q = $fetch_offrande_fiche['year']."-".$fetch_offrande_fiche['month'];
                                  ?>
                              <tr>
                                <td class="text-center"><a href='fiche_offrande.php?date=<?php echo $date_q;?> & culte=<?php echo $culte;?>' ><?php echo $date_q;?> </a></td>
                                <td class="text-center"><?php
                                $year=$fetch_offrande_fiche['year'];
                                $month=$fetch_offrande_fiche['month'];
                                $out_offrande_fiche_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and branche='$bid' and year(date)='$year' and month(date)='$month' 
                                  and tresorier='$treso' and usher is NULL and admin is NULL and confirmation is NULL and  branche='$bid';
