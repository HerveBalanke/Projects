...
$out_sorties=$con->query("select * from depense where tresorier!='-' and admin='-' and branche ='$bid';
											  	...
											  	<div class="table-responsive">
												    ...
												    <tbody>
												      ...
												      <tr>
												        ...
												        $query_un=$con->query("select nom, prenom from utilisateur where uid='$sign';") or die (print_r($con->errorInfo()));
