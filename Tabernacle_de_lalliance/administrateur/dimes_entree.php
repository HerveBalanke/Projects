          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> DIMES </b>
  											<?php 
  											if($count_dime>0){ ?>
  										<a href='dime_confirmation.php' style="color:rgb(255, 213, 29);" title="Vérifier les entrées" class="pull-right"> <b> Dimes à confirmer </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_dime ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
  										</div>
...
var dataString = "sid="+ sid+ "&date="+ date + "&id="+ id +"&mon="+ mon ;
