...
<html>
									...
									<br/>
										...
										<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> SORTIES </b> 
  									  	<a href='gerer_sorties.php' style="color:rgb(255, 213, 29);" title="Retour à la page principale" class="pull-right"> <b> Retour </b> </a> 
  										...
  										<div class="panel-body">
											...
											<div class="row">
											  ...
											  <div class="panel-body" id="ent_val">
											  	<?php include_once('sorties_rejetees_liste_un.php'); ?>
												  </div>
											</div>
  											</div>
  											<div class="col-md-1"></div>
	...
	<script src="../data_table/media/js/jquery.dataTables.min.js"></script>
	 ...
	 <script type="text/javascript">
		...
		bootbox.confirm("<b>Supprimer la sortie?</b>" , function(result) {
		if(result)
		{
			$.ajax({
			type: "POST",
			...
			success: function(html){
				$('#ent_val').load("sorties_rejetees_liste_un.php");
