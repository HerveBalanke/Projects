...
inner join t_membre on membre.t_membre=t_membre.tmid where branche='$bid';") or die (print_r($con->errorInfo()));
									  ...
									  <table class="table table-striped table-condensed table-hover" id="tab">
									    ...
									    <tbody>
									      ...
									      <tr>
									        ...
									        <td class="text-center" style="vertical-align:middle"><?php echo $fetch_mem ["type"];?></td>
