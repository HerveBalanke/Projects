<?php
					...
					include_once("session_admin.php");
		   			...
		   			$info_spi=$_POST["info_spi"];
		   			$per_urgence=$_POST["per_urgence"];
		   			...
		   			$insert_membre=$con->prepare("update membre set nom=?, prenom=?, genre=?, dob=?, nbre_denfant=?, pays=?, t_membre=?, profession=?, filiere=?, 
		   			...
		   			$insert_membre->execute(array( $nom, $prenom, $genre, $date, $ne, $pays, $sta, $prof, $fil, $ecole, $sim, $codetel, $tel, 
