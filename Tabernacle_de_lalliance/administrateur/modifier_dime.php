	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$did=$_GET['did'];
		   			$id=$_GET['id'];
		   			$out_dim=$con->query("select * from dime where diid='$did' and signataire_un='-' and signataire_deux='-' and signataire_trois='$id';") or die (print_r($con->errorInfo()));
...
var dataString ="did="+ did+ "&id="+ id + "&date="+ date + "&mid="+ mid +"&mon="+ mon ;
