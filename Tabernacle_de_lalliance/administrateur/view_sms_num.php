...
$sid=$_GET['sms_id'];
$out_sms=$con->query("select * from sms where sid='$sid' and branche='$bid' ;") or die (print_r($con->errorInfo()));
$fetch_sms=$out_sms->fetch();
$out_det=$con->query("select * from sms_envoi
inner join membre on sms_envoi.tel=membre.tel where sms_envoi.smsid ='$sid' and membre.branche='$bid' order by smsid;") or die (print_r($con->errorInfo()));
								...
								<div class="row"> 
         										...
         										<table class="table table-striped">
												    ...
												    <tbody>
													  	...
													  	$out_detn=$con->query("select tel from sms_envoi where smsid ='$sid';") or die (print_r($con->errorInfo()));
