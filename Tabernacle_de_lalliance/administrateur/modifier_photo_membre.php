...
$bid=$_SESSION["bid"];
$mid=$_GET["mid"];
$query=$con->query("select photo from membre where mid='$mid' and branche='$bid';") or die (print_r($con->errorInfo()));
...
<html>
        ...
        <div class="row">
          <div class="col-md-12">
						...
						<ul  class="nav nav-tabs">
									...
									<li><a href="utilisateur_out.php" >Liste des membres</a>
									</li>
								</ul>
												 ...
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>CHANGER LA PHOTO </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form" name="form" action="ajaxupload_membre_update.php" multipart/form-data role="form">
         												 ...
         												 <div class="col-md-4">
         												 	<input type="hidden" class="form-control" id="mid" value="<?php echo $mid ; ?>"  maxlength="10">
    ...
    window.location.href ='view_membre.php?mid='+mid;
	});
...
$(document).ready(function (e) {
 ...
 $("#form").on('submit',(function(e) {
  ...
  $('#lod').show();
  $.ajax({
         url: "ajaxupload_membre_update.php",
   type: "POST",
