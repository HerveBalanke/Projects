...
<html>
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
            ...
            $out_depense_fiche=$con->query("select * from depense where YEAR(date)='$year' and MONTH(date)='$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL order by did desc;") or die (print_r($con->errorInfo()));
           $count_depense_fiche=$out_depense_fiche->rowCount();

           $out_depense_sum=$con->query("select sum(montant) as sum from depense where YEAR(date)='$year' and MONTH(date)='$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL;") or die (print_r($con->errorInfo()));
        ...
        <div class="row">
          <div class="col-md-12">
					...
					<div class="panel panel-default">
                        ...
                        <a href='bilan_sorties.php'id='retour' style="color:rgb(255, 213, 29);" title="Retournez à la Page des Rapports" class="pull-right"> <b> Retour </b> </a>
                      </div>
    ...
    <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-center"><a href="sortie_desc_rap.php?soid=<?php echo $fetch_depense_fiche['did'];?>&date=<?php echo $date; ?>" title="Voir"><?php echo $fetch_depense_fiche['motif'];?> </a></td>
