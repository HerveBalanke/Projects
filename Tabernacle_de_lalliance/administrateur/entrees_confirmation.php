  										...
  										<div class="panel-body">
											...
											<div class="row">
											  ...
											  <div class="panel-body" id="er">
											  	<?php include_once('entrees_confirmer.php'); ?>
												  </div>
											</div>
  											</div>
  											<div class="col-md-1"></div>
	 ...
	 <script type="text/javascript">
						...
						if(result)
						{
							...
							success: function(response){
								{
									if(response=="OK"){
								$('#er').load("entrees_confirmer.php");
								bootbox.alert("<b>Entreé confirmée.</b>") ;
							...
							success: function(response){
								{
									if(response=="OK"){
								$('#er').load("entrees_confirmer.php");
								bootbox.alert("<b>Entreé rejetée.</b>") ;
								}else if (response=="USED"){
								$('#er').load("entrees_confirmer.php");
								bootbox.alert("<b>Donnée en cours d'utilisation... </b>");
								}
