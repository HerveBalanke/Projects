									...
									<br/>
										...
										<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> OFFRANDES </b> 
  											<?php 
  											if($count_offrande>0){ ?>
  										<a href='entrees_confirmation.php' style="color:rgb(255, 213, 29);" title="Confirmer les Offrandes" class="pull-right"> <b> Entrées à confirmer </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
  										</div>
