...
<html>
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
											...
											<div class="row">
  											...
  											<div class="col-md-10">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">CONFIRMATION DES ENTREES</div>
											  <div class="panel-body" id="ent_val">
											  	<?php include_once('dime_confirmer.php'); ?>
												  </div>
											</div>
  											</div>
  											<div class="col-md-1"></div>
	...
	<script src="../data_table/media/js/jquery.dataTables.min.js"></script>
	 ...
	 <script type="text/javascript">
 				...
 				function con(diid, id)
						{
						var info="diid="+ diid + "&id="+ id;
						bootbox.confirm("<b>Confirmer l'entrée?</b>" , function(result) {
						if(result)
						{
							$.ajax({
							type: "POST",
							url: "confirmer_dime.php",
							data: info,
							cache:true,
							processData:false,
							success: function(response){
								{
									if(response=="OK"){
								$('#ent_val').load("dime_confirmer.php");
								bootbox.alert("<b>Entrée Confirmée</b>");
							...
							success: function(response){
								{
									if(response=="OK"){
								$('#ent_val').load("dime_confirmer.php");
								bootbox.alert("<b>Entrée rejeter</b>");
								}else if (response=="USED"){
								$('#ent_val').load("dime_confirmer.php");
								bootbox.alert("<b>Donnée en cours d'utilisation... </b>");
								}
