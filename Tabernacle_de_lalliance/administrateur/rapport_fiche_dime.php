...
inner join membre on dime.membre=membre.mid where YEAR(dime.date) = '$year' AND MONTH(dime.date) = '$month' and
 tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and dime.branche='$bid' order by dime.date desc;
...
and tresorier!='-' and usher='oui' and admin='oui' and admin_id='$admin' and confirmation='oui' and dime.branche='$bid';
") or die (print_r($con->errorInfo()));
