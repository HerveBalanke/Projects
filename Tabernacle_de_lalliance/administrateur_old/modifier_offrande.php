    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$out_off=$con->query("select * from offrande 
		   				inner join evenement on offrande.evenement=evenement.eid where oid='$oid';") or die(print_r($con->errorInfo()));
											  ...
											  <div class="panel-body">
         										...
         										<form class="form-horizontal"  method="POST" id="form_entree" action="gerer_entrees.php" multipart/form-data role="form">
											  	<div class="form-group">
											  		<input type="hidden" class="form-control" id="oid"  value= "<?php echo $oid; ?>" placeholder="Entrez le Program Special" maxlength="30">
...
var dataString = "oid="+oid +"&date="+ date + "&culte="+ culte +"&rec="+ rec + "&culte_alt=" + culte_alt;
