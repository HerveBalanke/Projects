        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> LISTE DES BRANCHES </b> </div>
         										...
         										<table class="table table-striped table-condensed table-hover">
												      <thead>
													    ...
													    <tbody>
													      ...
													      <tr>
													        <td class="text-center" style="vertical-align:middle"> <a href="bilan.php?bid=<?php echo $fetch_branche ["bid"];?>"> <?php echo $fetch_branche ["branche"];?> </a> </td>
													      </tr>
