	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$out_ni=$con->query("select * from niveau;") or die (print_r($con->errorInfo()));
									...
									<li><a href="utilisateur_out.php" >LISTE DES UTILISATEURS</a>
										...
										<div id='check_b' style="color:red"></div>
														  ...
														  <div class="form-group">
														    ...
														    <div class="form-group" id='dept_case'>
														    <label class="control-label col-sm-2" for="dept">Departement:</label>
														    <div class="col-sm-5"> 
																  <select class="form-control" id="dept">
																	...
																	<?php
																	for($i=0; $i<$count_dept; $i++){
																		$fetch_dept=$out_dept->fetch();

																	?>
																    <option value= "<?php echo $fetch_dept ["deptid"];?>">
																    <?php echo $fetch_dept ["departement"];?> 
																  ...
																  <div id="block_dept">
																  <br/>
																  <input type="text" class="form-control" id="dept_alt" style="text-transform: capitalize;" placeholder="Entrez le Departement" maxlength="30">
																  <div id='check_dept_alt' style="color:red"></div>
																  </div>
																  <div id='check_dept' style="color:red"></div>
														    </div>
														  </div><br/><br/>
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-5"> 
																  <select class="form-control" id="branche">
																  	...
																  	<option>--- Choisissez une Branche ---</option>
	 	...
	 	$("#submit").click(function() {
			...
			if (prof=="Autre") {
				...
				dept = dept_alt;
					...
					if (dept=="--- Choisissez un Departement ---") {
				dept = "---";
					}
					if (branche=="Autre") {
				branche = branche_alt;
...
return false;
 }/*else if (dept.length == 0 || dept=="--- Choisissez un Departement ---" || dept=="Autre") {
$('#check_dept').html("*Selectionnez un <strong>Departement</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#dept").focus(); 
