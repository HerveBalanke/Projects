										          ...
										          <div class="col-md-8"> 
													...
													<div class="col-md-2"> </div>
													  ...
													  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">INFORMATION PERSONELLE
													  	<a href="modifier_utilisateur.php?id=<?php echo $id;?>" style="color:orange;" title="Modifier" class="pull-right"><span class="glyphicon glyphicon-edit"></span></a>
													  </div>
													  <div class="panel-body">
													  ...
													  <div class="panel-body">
													  	<div class="table-responsive table-condensed">
														    ...
														    <tbody>
														      ...
														      <tr>
														        <th>Departement</th>
														        <td><?php echo $fetch_info ["departement"];?></td>
														      </tr>
														      <tr>
														        <th>Branche</th>
