...
$out_offrande=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where evenement='$culte' ORDER BY date asc limit 6;") or die (print_r($con->errorInfo()));
