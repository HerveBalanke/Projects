...
$out_offrande_ver=$con->query("select * from offrande
inner join evenement on offrande.evenement=evenement.eid where tresorier!='-' and usher_id='$usher' and admin='non' and branche ='$bid' order by offrande.oid desc;
") or die (print_r($con->errorInfo()));
$count_offrande_ver=$out_offrande_ver->rowCount();
  										...
  										<div class="panel-body">
											  ...
											  <div class="panel-body">
         										<table class="table table-striped table-condensed table-hover" id="tab">
												    ...
												    <tbody>
												      <tr>
												      	<td><a href='entrees_confirmer.php' style="color:rgb(130, 0, 31);" title="Confirmer les entrées"><b> Entrées à confirmer </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande ;?> </b></span> </a> </td>
												        <td><a href='entrees_verifier.php' style="color:rgb(130, 0, 31);" title="Vérifier les entrées"><b> Entrées à vérifier </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande_ver ;?> </b></span> </a> </td>
												        </tr>
												    </tbody>
												  </table> 
											...
											<a href='entrees_personnelles.php'><button type="button"  class="btn btn-info">Liste des Transctions Effectuées</button> </a> 
											</div>
											</div>
