...
inner join evenement on offrande.evenement=evenement.eid where tresorier!='-' and usher_id='$usher' and branche ='$bid' order by offrande.oid desc;
									...
									<br/>
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
  											...
  											<div class="col-md-12">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> TRANSACTIONS EFFECTUEES - OFFRANDES</div>
											  <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
											  <input type="hidden" id="title" value="TRANSACTIONS EFFECTUEES - OFFRANDES <br/><br/><br/>" >
											  <div class="panel-body">
