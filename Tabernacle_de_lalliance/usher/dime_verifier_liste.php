											  	...
											  	<div class="table-responsive">
												    ...
												    <tbody>
												      ...
												      <tr>
												        ...
												        <td><?php echo $fetch_signu['nom']." ".$fetch_signu['prenom'].' - '.strtoupper($fetch_dime['usher']); ?></td>
												        <td><?php echo $fetch_signa['nom']." ".$fetch_signa['prenom'].' - '.strtoupper($fetch_dime['admin']); ?></td>
