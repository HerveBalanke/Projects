...
$out_dime=$con->query("select * from dime
	inner join membre on dime.membre=membre.mid where tresorier!='-' and usher_id='$usher' and dime.branche ='$bid' order by dime.diid desc;
									...
									<br/>
										...
										<div class="panel panel-default">
  										...
  										<div class="panel-body">
  											...
  											<div class="col-md-12">
  											<div class="panel panel-default">
											  <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> TRANSACTIONS EFFECTUEES - DIMES</div>
											  <input type="hidden" id="user" value="<?php echo '<br/><br/> Par: '.$_SESSION['uname']; ?>">
											  <input type="hidden" id="title" value=" TRANSACTIONS EFFECTUEES - DIMES <br/><br/><br/>" >
											  <div class="panel-body">
												    ...
												    <tbody>
												    	<?php
															...
															$fetch_dime=$out_dime->fetch();
													    		?>
												      <tr>
												        <td><?php echo $fetch_dime['membre'];?></td>
