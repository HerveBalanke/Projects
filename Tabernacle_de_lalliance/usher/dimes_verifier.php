									...
									<br/>
										...
										<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> DIMES </b> 
  									  	<!-- <a href='dimes_entree.php' style="color:rgb(255, 213, 29);" title="Retour à la page d'entrées" class="pull-right"> <b> Retour </b> </a>  -->
  										...
  										<div class="panel-body">
											...
											<div class="row">
											  ...
											  <div class="panel-body" id="ent_val">
											  	<?php include_once('dime_verifier_liste.php'); ?>
												  </div>
											</div>
  											</div>
  											<div class="col-md-1"></div>
	...
	<script src="../data_table/media/js/jquery.dataTables.min.js"></script>
	 ...
	 <script type="text/javascript">
						...
						if(result)
						{
							...
							{
								if(response=="OK"){
							$('#ent_val').load("dime_valider.php");
							bootbox.alert("<b>Entreé rejetée</b>" , function(result) {
							}); 
							}else if (response=="USED"){
							$('#ent_val').load("dime_valider.php");
							bootbox.alert("<b>Donnée en cours d'utilisation... </b>" , function(result) { });
							}
							}
