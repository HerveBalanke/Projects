	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$out_dim=$con->query("select * from dime where signataire_un='-' and signataire_deux='$id' and signataire_trois='-' and diid='$did';") or die (print_r($con->errorInfo()));
		   			$fetch_dim=$out_dim->fetch();
		   			$count_row=$out_dim->rowCount();
		   			if($count_row<=0){
		   				header('location:alert_used_dime.php');
    					exit();
		   			}
...
var dataString ="did="+ did+ "&sid="+ sid + "&date="+ date + "&id="+ id +"&mon="+ mon ;
...
success: function(result){
	...
	$("#flash").fadeIn(400).html(bootbox.alert("<b>Modification terminée.</b>" , function(result) {
			window.location.href ="dimes_entree.php";
		}));
