												    ...
												    <tbody>
												    	<?php
															...
															$fetch_offrande=$out_offrande->fetch();
													    		?>
												      <tr>
												        <td><a href='entrees_verifier.php' style="color:rgb(255, 213, 29);" title="Vérifier les entrées"><b> Entrées à vérifier </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande ;?> </b></span> </a> </td>
												        <td><a href='entrees_rejetees.php' style="color:rgb(255, 213, 29);" title="Entrées rejetées"> <b> Entrées rejetées </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande_rej ;?> </b></span> </a> </td>
												        </tr>
