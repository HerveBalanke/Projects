      ...
      <meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
           ...
           $out_offrande_fiche=$con->query("select date, recette from offrande
            inner join evenement on offrande.evenement=evenement.eid where offrande.evenement='$culte' and YEAR(offrande.date) = '$year' AND MONTH(offrande.date) = '$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL order by offrande.date desc;
           ...
           $out_offrande_fiche_sum=$con->query("select sum(recette) as sum from offrande
            inner join evenement on offrande.evenement=evenement.eid where offrande.evenement='$culte' and YEAR(offrande.date) = '$year' AND MONTH(offrande.date) = '$month' and signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL;
              ") or die (print_r($con->errorInfo()));
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="panel panel-default">
                     ...
                     <a href='offrande_stat.php?culte=<?php echo $culte;?>&id=<?php echo $id; ?>'id='retour' style="color:rgb(255, 213, 29);" title="Retournez à la liste des mois" class="pull-right"> <b> Retour </b> </a>
                      </div>
