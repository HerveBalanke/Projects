						...
						<ul  class="nav nav-tabs">
									...
									<li><a href="utilisateur_out.php" >Liste des Utilisateurs</a>
										...
										<br/>
										  	...
										  	<div class="panel panel-default">
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>MODIFIER UTILISATEUR </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form_membre" action="modifier_utilisateur.php" multipart/form-data role="form">
											...
											<option data-countryCode="GH" value="<?php //echo $fetch_info['facebook']; ?>">Ghana (+233)</option>
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-5"> 
																  <select class="form-control" id="ac">
																  	...
																  	<option value="<?php echo $fetch_info['acid']; ?>" selected='selected'><?php echo $fetch_info['activite']; ?></option>
														  ...
														  <div class="form-group">
														    ...
														    <div class="col-sm-5"> 
																  <select class="form-control" id="pr">
																  	<option value="<?php echo $fetch_info['niveau']; ?>" selected='selected'>---</option>
...
success: function(out){
	...
	window.location.href ='utilisateur_photo_mod.php';
	});
