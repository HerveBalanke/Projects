	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$sid=$_GET['sms_id'];
		   			$out_sms=$con->query("select * from sms where sid='$sid';") or die (print_r($con->errorInfo()));
		   			$fetch_sms=$out_sms->fetch();
		   			$out_det=$con->query("select * from sms_envoi
		   			inner join membre on sms_envoi.tel=membre.tel where sms_envoi.smsid ='$sid' order by smsid;") or die (print_r($con->errorInfo()));
