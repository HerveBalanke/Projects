<?php
					...
					include_once("session_deux.php");
		   			...
		   			$insert_culte=$con->prepare("insert into offrande (date, recette, evenement)
		   										values(?,?,?);") or (print_r($con->errorInfo()));
		   			$insert_culte->execute(array($date, $rec, $culte)) or (print_r($con->errorInfo()));
		   			...
		   			$insert_culte=$con->prepare("insert into offrande (date, recette, evenement, signataire_deux)
		   										values(?,?,?,?);") or (print_r($con->errorInfo()));
