	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$soid=$_GET['soid'];
		   			$id=$_GET['id'];
		   			$out_sor=$con->query("select * from depense where did='$soid' and signataire_un='-' and signataire_deux ='$id' and signataire_trois='-';") or die (print_r($con->errorInfo()));
...
var dataString = "soid="+soid + "&id="+id + "&date="+ date + "&desc="+ desc +"&motif="+ motif +"&mon="+ mon ;
