	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$out_sorties_rej=$con->query("select * from depense where signataire_un is NOT NULL and signataire_deux ='$id' and signataire_trois is NULL;
		   				") or die (print_r($con->errorInfo()));
		   			$count_sorties_rej=$out_sorties_rej->rowCount();
		   			?>
          ...
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> SORTIES </b> 
  											<?php 
  											if($count_sorties>0){ ?>
  											<a href='sorties_verifier.php' style="color:rgb(255, 213, 29);" title="Vérifier les sorties" class="pull-right"> <b> &nbsp;&nbsp;&nbsp; Sorties à vérifier </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_sorties ;?> </b></span> </a> 
  											<?php 
  											}
  											?>

  											<?php 
  											if($count_sorties_rej>0){ ?>
  											<a href='sorties_rejetees.php' style="color:rgb(255, 213, 29);" title="Vérifier les sorties" class="pull-right"> <b> Sorties rejetées </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_sorties_rej ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
...
var dataString = "sid="+sid +"&date="+ date + "&desc="+ desc +"&motif="+ motif +"&mon="+ mon ;
