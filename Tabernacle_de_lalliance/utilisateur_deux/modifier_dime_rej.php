	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$out_dim=$con->query("select * from dime where diid='$did' and signataire_un is NOT NULL and signataire_deux ='$id' and signataire_trois is NULL;") or die (print_r($con->errorInfo()));
...
success: function(result){
	...
	$("#flash").fadeIn(400).html(bootbox.alert("<b>Modification terminée.</b>" , function(result) {
			window.location.href ="dime_rejetees.php";
		}));
