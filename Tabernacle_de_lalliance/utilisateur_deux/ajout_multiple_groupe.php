        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
									  ...
									  <a href='gerer_liste.php?groupe=<?php echo $groupe;?>' title="Annuler l'opération">Annuler</button> 
									</form>
									</div>
...
success: function(result){
	...
	$('#form').clearForm();	
	if (result=="OK"){
		$("#flash").fadeIn(400).html(bootbox.alert("<b>Membres Ajoutés.</b>" , function(result) {
