	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			$soid=$_GET['soid'];
		   			$id=$_GET['id'];
		   			$out_sor=$con->query("select * from depense where did='$soid' and signataire_un is NOT NULL and signataire_deux='$id' and signataire_trois is NULL;") or die (print_r($con->errorInfo()));
        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										...
  										<a href="sorties_rejetees.php?date=<?php echo $fetch_sor['date']; ?>&id=<?php echo $id; ?>"id='retour' style="color:rgb(255, 213, 29);" title="Retournez vers la liste des Sorties" class="pull-right"> <b> Retour </b> </a>
  										</div>
