	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			if($count_row<=0){
		   				header('location:alert_used_sortie_b.php');
    					exit();
		   			}
		   			?>
													...
													<div class="form-group">
														  ...
														  <div class="form-group"> 
														    <div class="col-sm-offset-2 col-sm-10">
														      ...
														      <a href="sorties_rejetees.php" title="Annuler l'operation">Annuler</a>
														    </div>
														  </div>
...
$.ajax({
type: "POST",
url: "modifier_sortie_eng_rej.php",
data:dataString,
cache:true,
success: function(result){
	...
	$("#flash").fadeIn(400).html(bootbox.alert("<b>Modification terminée.</b>" , function(result) {
			window.location.href ="sorties_rejetees.php";
		}));
