...
<html>
	...
	<head>
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
		   			...
		   			inner join evenement on offrande.evenement=evenement.eid where signataire_un='-' and signataire_deux='$id' and signataire_trois='-' order by offrande.oid desc limit 15;
