      ...
      this.selectedIndex = 0;
		...
		$("#submit").click(function() {
			...
			success: function(out){
				...
				$('#lod').hide();
				bootbox.alert("<strong> Envoi du SMS avorté! Verifiez le numero de tel du destinataire, la connection Internet et Le compte de credit SMS</strong>" , function(result) { 
				$('#form').clearForm();
				window.location.href ='communication.php'
			});
