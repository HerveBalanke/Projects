...
where utilisateur.uid='$id' and niveau.niid not in (1, 2, 4, 5, 6);") or die (print_r($con->errorInfo()));
												 ...
												 <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>MODIFIER UTILISATEUR </b></div>
													...
													<div class="panel-body">
														...
														<form class="form-horizontal"  method="POST" id="form" action="modifier_utilisateur.php" multipart/form-data role="form">
														  ...
														  <div id="flash"></div>
														  <input type="hidden" class="form-control" id="bid" style="text-transform: capitalize;" value="<?php echo $bid;?>">
														  <input type="hidden" class="form-control" id="id" style="text-transform: capitalize;" value="<?php echo $id;?>">
