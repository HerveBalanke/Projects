...
$out_ni=$con->query("select * from niveau where niveau.niid not in (1, 2, 4, 5, 6);") or die (print_r($con->errorInfo()));
...
else if (ni.length == 0 || ni=="--- Choisissez une Responsabilité ---") {
...
var dataString = "nom="+ nom +"&prenom="+ prenom +"&genre="+ genre +"&date="+ date +"&pays="+ pays +
 "&prof="+ prof + "&lha="+ lha +"&mail="+ mail+"&fac="+ fac + "&codet="+ a +"&tel="+ tel+ "&codew="+ b +
 "&whatsapp="+ whatsapp +"&ni="+ ni + "&bid=" + bid+
 "&prof_alt="+ prof_alt;
