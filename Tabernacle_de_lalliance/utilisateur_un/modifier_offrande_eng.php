<?php
		   			...
		   			$update_offrande=$con->prepare("update offrande set date=?, recette=?, evenement=?,  signataire_deux=?, signataire_trois=? where oid=? and signataire_un=?;") or (print_r($con->errorInfo()));
