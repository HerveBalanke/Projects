									...
									<br/>
										...
										<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> OFFRANDES </b> 
  											<?php 
  											if($count_offrande>0){ ?>
  										<a href='entrees_rejetees.php' style="color:rgb(255, 213, 29);" title="Vérifier les entrées" class="pull-right"> <b> Entrées Rejetées </b>  <span class="badge" style="color:rgb(130, 0, 31); background:rgb(255, 213, 29);"><b> <?php echo $count_offrande ;?> </b></span> </a> 
  											<?php 
  											}
  											?>
  										</div>
  										<div class="panel-body">
											  ...
											  <div class="panel-body">
         										...
         										<input type="hidden" class="form-control" id="sid" value="<?php echo $id; ?>">
	...
	<script src="../data_table/media/js/jquery.dataTables.min.js"></script>
	 ...
	 <script type="text/javascript">
				...
				$('#tabtwo').dataTable();
						...
						function sup_id(oid, id)
						{
						var info="oid="+ oid + "&id="+ id;
...
var dataString = "sid="+ sid +"&date="+ date + "&culte="+ culte +"&rec="+ rec + "&culte_alt=" + culte_alt;
