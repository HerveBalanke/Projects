	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			inner join evenement on offrande.evenement=evenement.eid where signataire_un='$id' and signataire_deux='-' and signataire_trois='-' and oid='$oid';") or die(print_r($con->errorInfo()));
