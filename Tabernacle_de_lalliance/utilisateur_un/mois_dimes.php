<?php  
	...
	$date_out=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM dime where tresorier='$treso' and confirmation='oui' and branche='$bid' ORDER BY date desc;");
