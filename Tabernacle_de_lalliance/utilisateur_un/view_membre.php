									...
									<div id="flash"> </div>
										...
										<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> INFORMATION DU MEMBRE </b> 
  											<a href='membre_out.php' style="color:rgb(255, 213, 29);" title="Retour à La Liste des Membres" class="pull-right"> <b> Retour </b> </a> </div>
  										<div class="panel-body">
  											...
  											<a href="modifier_membre.php?mid=<?php echo $fetch_out_membre ['mid'];?>" style="color:orange;" title="Modifier" class="pull-right"><span class="glyphicon glyphicon-edit"></span></a>
										          	...
										          	<div class="col-md-6">
														  ...
														  <a href="membre_dime.php?mid=<?php echo $mid;?>"> <button type="button" class="btn btn-info"> Historique des dimes</button> </a>&nbsp;&nbsp;&nbsp;
														  <a href="carte_membre.php?mid=<?php echo $mid;?>"> <button type="button" class="btn btn-default">Carte de Membre</button> </a>
