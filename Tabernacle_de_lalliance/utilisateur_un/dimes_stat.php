...
$out_dime_fiche=$con->query("select * from dime where YEAR(date)='$year' and MONTH(date)='$month' and where tresorier='$treso' and confirmation='oui' and branche='$bid' order by dime.diid desc;") or die (print_r($con->errorInfo()));
$count_dime_fiche=$out_dime_fiche->rowCount();

$out_dime_sum=$con->query("select sum(montant) as sum from dime where YEAR(date)='$year' and MONTH(date)='$month' and where tresorier='$treso' and confirmation='oui' and branche='$bid';") or die (print_r($con->errorInfo()));
