											  	...
											  	<div class="table-responsive">
												    ...
												    <tbody>
												      ...
												      <tr>
												        ...
												        <?php 
												        $sign=$fetch_sorties['tresorier'];
												        $query=$con->query("select nom, prenom, niveau from utilisateur inner join niveau 
												        on utilisateur.niveau=niveau.niid where uid='$sign';") or die (print_r($con->errorInfo()));
