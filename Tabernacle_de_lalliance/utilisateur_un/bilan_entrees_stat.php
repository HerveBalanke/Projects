...
<html>
	...
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
           ...
           $out_offrande_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where evenement='$culte' ORDER BY date desc;
...
$out_offrande=$con->query("select * from (select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where evenement='$culte' ORDER BY date desc limit 6) as tab order by tab.year, tab.month asc;") or die (print_r($con->errorInfo()));
...
$out_offrande_c_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and year(date)='$yearc' and month(date)='$monthc';") or die (print_r($con->errorInfo()));
    ...
    <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                $out_offrande_fiche_sum=$con->query("select sum(recette) as sum FROM offrande where evenement='$culte' and year(date)='$year' and month(date)='$month';
                                ") or die (print_r($con->errorInfo()));
