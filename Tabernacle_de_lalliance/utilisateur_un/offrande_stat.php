  ...
  <head>
      ...
      <meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
           ...
           $out_offrande_fiche=$con->query("select distinct extract(year from date) as year , extract(month from date) as month FROM offrande where signataire_un is NOT NULL and signataire_deux is NOT NULL and signataire_trois!='-' and signataire_trois is NOT NULL and evenement='$culte' ORDER BY date desc;
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="panel panel-default">
                      <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> OFFRANDES - <?php echo strtoupper($fetch_offrande_info['evenement']); ?></b> 
                        <a href='gerer_entrees.php' id='retour' style="color:rgb(255, 213, 29);" title="Retournez au Portail des Offrandes" class="pull-right"> <b> Retour </b> </a>
                      </div>
      ...
      <div class="panel-body">
                            ...
                            <tbody>
                              ...
                              $date_q = $fetch_offrande_fiche['year']."-".$fetch_offrande_fiche['month'];
                                  ?>
                              <tr>
                                <td class="text-center"><a href='fiche_offrande.php?date=<?php echo $date_q;?> & culte=<?php echo $culte;?> & id=<?php $id;?>' ><?php echo $date_q;?> </a></td>
