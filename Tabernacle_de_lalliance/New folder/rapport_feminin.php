	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$mem_fem=$con->query("select * from membre where genre='F';") or die (print_r($con->errorInfo()));
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
  										<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b> MEMBRES FEMININ </b> </div>
