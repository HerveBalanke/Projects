						...
						<ul  class="nav nav-tabs">
									...
									<li><a href="utilisateur_out.php" >Liste des Utilisateurs</a>
										...
										<div id='check_b' style="color:red"></div>
														  ...
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="ac">Responsabilité:</label>
														    <div class="col-sm-5"> 
																  ...
																  <div id="block_ac">
																  <br/>
																  <input type="text" class="form-control" id="ac_alt" style="text-transform: capitalize;" placeholder="Entrez la Responsabilité" maxlength="50">
																  <div id='check_ac_alt' style="color:red"></div>
																  </div>
																  <div id='check_ac' style="color:red"></div>
																  <div id='check_ac_exist' style="color:red"></div>
														    </div>
														  </div>
														  <div class="form-group">
														    <label class="control-label col-sm-2" for="pr">Priorité:</label>
														    <div class="col-sm-5"> 
																  <select class="form-control" id="pr">
																  	<option>--- Choisissez une Priorité ---</option>
																  	<option value= "1"> Signataire 1</option>
																    <option value= "2"> Signataire 2</option>
																	<option value= "3"> Administrateur</option>

																  </select>
																  <div id='check_pr' style="color:red"></div>
														    </div>
														  </div> <br/><br/>
...
else if (ac.length == 0 || ac=="--- Choisissez une Responsabilité ---" || ac=="Autre") {
$('#check_ac').html("*Selectionnez une <strong>Responsabilité</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#ac").focus(); 

$("#ac").change(function(){ $('#check_ac').hide();
});
return false;
}else if (pr.length == 0 || pr=="--- Choisissez une Priorité ---" || pr=="Autre") {
$('#check_pr').html("*Selectionnez une <strong>Priorité</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#pr").focus(); 

$("#pr").change(function(){ $('#check_pr').hide();
});
return false;
} else{
...
var dataString = "nom="+ nom +"&prenom="+ prenom +"&genre="+ genre +"&date="+ date +"&pays="+ pays +
 "&prof="+ prof + "&lha="+ lha +"&mail="+ mail+"&fac="+ fac +"&tel="+ tel+ "&whatsapp="+ whatsapp +"&ac="+ ac +
 "&prof_alt="+ prof_alt +"&ac_alt=" + ac_alt+ "&pr=" + pr;
...
success: function(out){
	...
	window.location.href ='utilisateur_photo.php';
	});
