	...
	<head>
    		...
    		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
   			...
   			<link rel="stylesheet" type="text/css" href="../Lib_bootstrap/dist/sweetalert.css">
		   			...
		   			$out_membre=$con->query("select mid, nom, prenom, email from membre;") or die (print_r($con->errorInfo()));
          ...
          <div class="col-md-12">
          				...
          				<ul  class="nav nav-tabs">
								...
								<div class="panel panel-default">
									  ...
									  <a href="groupe_com.php?mess=<?php echo $mess; ?>& head=<?php echo $head; ?>"> Envoi aux Groupes </a>&nbsp;&nbsp;&nbsp;
