			...
			/*if($_GET['id']!='' && $_GET['niveau']!=''){
		   	...
		   	if($niveau==1){
		   			...
		   			<body>
						...
						<div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);">Carte d'utilisateur</div>
         		 	...
         		 	<img src="../images/1.jpg" class="img-rounded img-responsive" alt="Cinque Terre" style="max-width:170px;height:auto" >
