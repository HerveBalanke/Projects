        ...
        <div class="row">
          <div class="col-md-12">
								...
								<div class="panel panel-default">
  										...
  										<a href="groupe_com.php?sms=<?php echo $sms; ?>&zone=<?php echo $zone; ?>" style="color:rgb(255, 213, 29);" title="Retour vers la page précédente" class="pull-right"> <b> <<< Revenir</b> </a>
  										</div>
										...
										<thead>
									      <tr>
									        <th class="text-center">&nbsp;&nbsp;</th>
												    ...
												    <tbody>
												      <tr>
												        <td><a href="com_liste_evangelisation.php?sms=<?php echo $sms; ?>&zone=<?php echo $zone; ?>">Liste des Evangélisés</a></td>
												    </tr>
												    <tr>
