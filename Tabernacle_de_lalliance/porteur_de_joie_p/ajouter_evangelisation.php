      ...
      <div class="container">
        ...
        <div class="col-md-6">
          <div class="panel panel-default">
                         <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>AJOUTER UN(E) EVANGELISE(E)</b></div>
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
                         <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"> <b>LISTE DES ZONES</b></div>

                          <div class="panel-body" id="tab_un">
                            <?php include_once('liste_zone.php'); ?>
          ...
          <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="color:rgb(255, 213, 29); background:rgb(130, 0, 31);"><b>LISTE DES EVANGELISE(E)S</b></div>
                <div class="panel-body" id="tab_deux">
                 <?php include_once('evangelisation_liste.php'); ?>
              </div>
            </div>
          </div>
      </div>
 ...
 $(document).ready(function(){
  ...
  <script type="text/javascript">
      ...
      function sup_eid(eid)
            { 
              var info="eid="+ eid;
            bootbox.confirm("<b>Evangélisé(e) Supprimé(e)</b>" , function(result) {
            if(result)
            {
              $.ajax({
              type: "POST",
              ...
              success: function(html){
                $('#tab_deux').load("evangelisation_liste.php");
    ...
    $('#lod').hide();
              ...
              if (zone=="Autre") {
                  zone = zone_alt;
                    ...
                    var dataString ="nom="+ nom + "&prenom=" + prenom + "&tel=" + tel + "&zone=" + zone + "&zone_alt="+ zone_alt + "&date=" + date;
                    
                    $('#lod').show();
                    $.ajax({
                    type: "POST",
                    url: "ajouter_evangelisation_eng.php",
                    data:dataString,
                    cache:true,
                    processData:false,
                    success: function(out){
                    {
                          ...
                          $('#form').clearForm();
                          $('#lod').hide();
                          bootbox.alert("<strong>Evangélisé(e) ajouté(e)!</strong>");
                          $('#tab_deux').load("evangelisation_liste.php");
                          $('#tab_un').load("liste_zone.php");
                          }else if (out=="NO_zone"){
                          $('#lod').hide();
