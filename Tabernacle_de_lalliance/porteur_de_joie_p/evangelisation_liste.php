...
$out_evangelisation=$con->query("select * from evangelisation inner join zone on zone.zid=evangelisation.zone order by eid desc;") or die (print_r($con->errorInfo()));
											  	...
											  	<div class="table-responsive">
												    ...
												    <tbody>
												      ...
												      <tr>
												        ...
												        <td class="text-center"><?php echo $fetch_evangelisation['zone'];?></td>
