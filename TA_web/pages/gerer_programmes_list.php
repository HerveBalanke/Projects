...
<html>
	...
	<body>
		...
		<div class="section" style="color:rgb(255, 213, 29);">
			...
			<div id='load'>
				  <?php include('gerer_programmes_load.php'); ?>
			</div>
         ...
         <div class="row"  style="color:rgb(104, 1, 1); background:rgb(255, 213, 29);" id="footer">
			...
			<script type="text/javascript">
    			...
    			function sup_pid(pid)
						{
						var info="pid="+ pid;
						bootbox.confirm("<b>Supprimer le programme?</b>" , function(result) {
						if(result)
						{
							$.ajax({
							type: "POST",
							url: "supprimer_programme.php",
							data: info,
							cache:true,
							processData:false,
							success: function(response){
									if(response=="OK"){
								$('#load').load("gerer_programmes_load.php");
								}
								}
									});		  
										}
