...
<html>
  ...
  <div class="container-fluid" id="nv">
     ...
     <ul class="nav navbar-nav navbar-right" id="navbar">
      <li><a href="gerer_programme.php">Gerer programmes</a></li>
          <li><a href='ajouter_photo.php'>Gerer galerie</a></li>
            <li class="active"><a href="gerer_messages.php">Gerer messages</a></li>
    ...
    <div class="jumbotron" style="font-family:'century gothic', 'trebuchet MS', verdana;">
                <h1>Gerer messages</h1> 
                <ul> 
        <li style="color:rgb(255, 213, 29);"> <a href='gerer_messages.php' style="color:rgb(255, 213, 29);"> <b> Documents </b> </a> </li>
        <li style="color:rgb(104, 1, 1);"> <a href='gerer_audios.php' style="color:rgb(104, 1, 1);"> Audios </a> </li>
      </ul> 
          </div><br/><br/>
     ...
     <div class="section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                            ...
                            <div class="row">
                                 <div class="col-md-10" id="sec" style="background-color:rgb(255, 255, 255);">
                                  <h1 class="text-center" style="color:rgb(104, 1, 1);"> <b> Ajouter Document</b> </h1>
                            <form class="form-horizontal"  method="POST" action="gerer_messages.php"  enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  <input type="date" class="form-control" name="date" id="date" style="text-transform: capitalize;" placeholder="Entrez la date" maxlength="30">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" name="titre" id="titre" style="text-transform: capitalize;" placeholder="Entrez le titre" maxlength="30">
                                  <div id='check_titre' style="color:red"></div>
                                </div>
                              </div>

                              <div class="form-group">
                                <label class="control-label col-sm-2" for="file">Document <span style="color:red;">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-md-2">
                              <a href="gerer_documents.php"> <button type="button" id="manage" name="manage" class="btn btn-default" style="background-color:rgb(255, 213, 29); border:rgb(255, 213, 29); outline:none;">Gerer Documents</button> </a>
                            </div>
          ...
          <?php include "gerer_messages_eng.php"; ?>
...
$('#check_file').html("*Selectionner un <strong>document</strong>").show(); // This Segment Displays The Validation Rule For All Fields
$("#file").focus(); 
