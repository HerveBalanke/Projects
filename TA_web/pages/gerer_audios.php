...
<html>
  ...
  <div class="container-fluid" id="nv">
    ...
    <div class="jumbotron" style="font-family:'century gothic', 'trebuchet MS', verdana;">
                ...
                <ul> 
        <li style="color:rgb(104, 1, 1);"> <a href='gerer_messages.php' style="color:rgb(104, 1, 1);"> Documents </a> </li>
        <li style="color:rgb(255, 213, 29);"> <a href='gerer_audios.php' style="color:rgb(255, 213, 29);"> <b> Audios </b></a> </li>
      </ul> 
          </div><br/><br/>
     ...
     <div class="section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                            ...
                            <div class="row">
                                 <div class="col-md-10" id="sec" style="background-color:rgb(255, 255, 255);">
                                  <h1 class="text-center" style="color:rgb(104, 1, 1);"> <b> Ajouter audio</b> </h1>
                            <form class="form-horizontal"  method="POST" action="gerer_audios.php"  enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="file">Audio <span style="color:red;">*</span></label>
                                <div class="col-sm-8">
                            ...
                            <div class="col-md-2">
                             <a href="gerer_audios_list.php"> <button type="button" id="manage" name="manage" class="btn btn-default" style="background-color:rgb(255, 213, 29); border:rgb(255, 213, 29); outline:none;">Gerer Audios</button> </a>
                            </div>
          ...
          <?php include "gerer_audios_eng.php"; ?>
