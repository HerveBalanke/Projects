	...
	<body>
		    ...
		    <div class="collapse navbar-collapse" id="navbar_col">
		     <ul class="nav navbar-nav navbar-right" id="navbar">
		      <li><a href="gerer_programme.php">Gerer programmes</a></li>
                  ...
                  <li style="color:rgb(255, 213, 29);"> <a href='gerer_photo_album.php' style="color:rgb(255, 213, 29); font-weight:bold;"> Albums </a> </li> 
                	</ul>
          			</div><br/><br/>
		...
		<div class="section" style="color:rgb(255, 213, 29);">
			<div class="container-fluid">
				<div id='load'>
				  <?php include('gerer_photo_load_album.php'); ?>
				  </div>
         ...
         <div class="row"  style="color:rgb(104, 1, 1); background:rgb(255, 213, 29);" id="footer">
			...
			<script type="text/javascript">
   			 ...
   			 function sup_titre(titre)
						{
						var info="titre="+titre;
						bootbox.confirm("<b>Supprimer l'album? </b>" , function(result) {
						if(result)
						{
							$.ajax({
							type: "POST",
							url: "supprimer_photo_album.php",
							data: info,
							cache:true,
							processData:false,
							success: function(response){
									if(response=="OK"){
								$('#load').load("gerer_photo_load_album.php");
								}
								}
									});		  
										}
