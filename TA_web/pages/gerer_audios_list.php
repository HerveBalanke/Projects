...
<html>
	...
	<body>
		...
		<div class="section" style="color:rgb(255, 213, 29);">
			...
			<div id='load'>
				  <?php include('gerer_audios_list_load.php'); ?>
			</div>
         ...
         <div class="row"  style="color:rgb(104, 1, 1); background:rgb(255, 213, 29);" id="footer">
			...
			<script type="text/javascript">
    			...
    			function sup_aid(aid)
						{
						var info="aid="+ aid;
						bootbox.confirm("<b>Supprimer l'audio?</b>" , function(result) {
						if(result)
						{
							$.ajax({
							type: "POST",
							url: "supprimer_audio.php",
							data: info,
							cache:true,
							processData:false,
							success: function(response){
									if(response=="OK"){
								$('#load').load("gerer_audios_list_load.php");
								}
								}
									});		  
										}
