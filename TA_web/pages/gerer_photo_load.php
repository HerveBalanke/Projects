...
<html>
	...
	<head>
   			...
   			<link rel="stylesheet" type="text/css" href="../data_table/media/css/jquery.dataTables.min.css">
					...
					$query=$con->query("SELECT * from galerie;");
	...
	<body>
					...
					<div class="row">
        			 ...
        			 <div class="col-md-8" style="background-color:rgb(255, 255, 255);"> 
        			 	<h1 class="text-center" style="color:rgb(104, 1, 1);"> <b> Gerer les photos </b></h1>
							  ...
							  <table class="table table-striped table-condensed table-hover" style="background-color:rgb(255, 255, 255); color:rgb(0, 0, 0);" id="tab">
							    ...
							    <tbody>
							      ...
							      <tr>
							        ...
							        <td class="text-center" style="vertical-align:middle"><a href="javascript:sup_gid(<?php echo $fetch_titre ['gid'];?>)" style="color:red; " ><span class="glyphicon glyphicon-remove"></span></a></td>
							      </tr>
