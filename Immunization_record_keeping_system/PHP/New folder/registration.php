				...
				<section>
							...
							<div id="flash"> </div><br/>
								  <div class="form-group">
									<label for="fname" class='a'>First Name</label>
									<input type="fname" class="form-control" name="fname" id="fname" maxlength="30" >
								  </div>
								  <div class="form-group">
									<label for="lname" class='b'>Last Name</label>
									<input type="lname" class="form-control" name="lname" id="lname" maxlength="30">
								  </div> <br/><br/><br/>
