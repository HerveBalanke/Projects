  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">Edit Patient</h1> <br/>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="form-horizontal" id="login-form" role="form" action="edit_patient.php" method="POST">
              <div class="form-group">
    <input type="hidden" class="form-control" id="pid" value="<?php print $lis["pid"]; ?>">
  </div>
              <div class="form-group">
                <div class="col-sm-2">
...
var dataString = "pid="+ pid +"&fname="+ fname +"&lname="+ lname +"&gender="+ gender +"&dob="+ dob 
...
success: function(html){
  $("#sec").load("form.php");
$("#flash").html(html);
setTimeout(' window.location.href = "view_patient.php"; ',2000);
