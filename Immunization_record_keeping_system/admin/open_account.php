...
$message="Hello $fname $lname, here are your
...
$mail->Subject = 'FIS account credentials';
$mail->Body    = $message;
...
/*if(!$mail->send()) {
   ...
   // echo 'Message could not be sent.';
    ...
    <div class='alert alert-warning text-center'>
        ...
        <p><strong>Account Activated <br/> Message could not be sent.<br/><br/>
...
<div class="col-md-4">
    <div class='alert alert-success text-center'>
        <a href='view_staff.php' class='close' data-dismiss='alert' ></a>
        <strong>Account Activated <br/> Message has been sent.</strong>
      </div>
      </div>
      <div class="col-md-4"></div>
