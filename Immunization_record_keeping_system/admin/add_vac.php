 ...
 <body>
  ...
  <div class="form-group">
    <input type="hidden" class="form-control" id="date" value="<?php echo date("Y-m-d"); ?>">
        ...
        <input type="number" value="10" min="0" max="999" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" 
              ...
              <div class="form-group">
                 <div class="col-sm-2">
                   ...
                   <input type="number" class="form-control" id="ndose" min="1" value="1"  max="300"  >
        ...
        <input type="number"  class="form-control" id="alength"  min="1" value="1" max="300"  />
...
var dataString = "vcode="+ vcode +"&vname="+ vname +"&nod="+ nod +"&length="+ length +"&price="+ price +"&manu="+ manu +"&manuemail="+ manuemail +"&qty="+ qty +"&date="+ date;
//alert(dataString);
