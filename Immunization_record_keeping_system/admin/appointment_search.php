...
try{
            ...
            $session3=$session2["fname"];*/
                ...
                if ($count<=0){
                  print "No record found for "; print $search; echo"!<br/>
                  <div class='col-md-4'> <h6 class='text-center'> <a href='view_app.php'> Return</a> </h6> </div>
                  ";
                }elseif($count>0){ ?>
          ...
          <div class="col-md-12">
            ...
            ?>
                ...
                <div class="row">
          <div class="col-md-12">
            <a href='view_app.php' >View all </a> 
