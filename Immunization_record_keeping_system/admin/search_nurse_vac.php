...
try{
         ...
         <div class="col-md-4">
        ...
        </div> <div class="col-md-4"> <h6 class="text-center"> <a href="nurse_vac.php"> Return</a> <br/><br/></h6> </div>
                  '; 
          ...
          <div class="col-md-12">
            ...
            ?>
                  ...
                  <td ><a href="edit_staff.php?nid=<?php print $list["nid"]; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                  <td><a  href="javascript:delete_id(<?php echo $list["nid"]; ?>)"><span class="glyphicon glyphicon-trash"></span></a></td>
                  </tr>
            ...
            ?>
                ...
                <div class="row">
          <div class="col-md-12">
            <a href='nurse_vac.php' >View all </a> 
