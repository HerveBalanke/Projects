...
<html>
    ...
    <?php
      ...
      try{
        ...
        //$query1=$cons->query("select * from dose;");
        //$row1=$query1->rowCount();
        //print $row;

        $vid=$_GET['vid'];
            $outs=$cons->query("select * from vaccination where vid='$vid';") or die (print_r($outs->errorInfo()));
            $fetch=$outs->fetch();
            $pid=$fetch["patient"];
           // $dos=$fetch["dose"];
            //$row= $out-> rowCount();
...
<div class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="form-horizontal" role="form" id="vaccination" action="vaccination2.php" method="POST">
    ...
    <input type="hidden" class="form-control" id="qty" value=0>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="pid" value="<?php print $fetchpa['pid'];?>" placeholder="Enter Patient ID" maxlength="30">
                  <div id='check_pid' style="color:red"></div>
                </div>
                <div class="col-sm-4">
                  <input type="hidden" class="form-control" id="vid" value="<?php print $vid;?>" maxlength="30">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="button" name="submit" class="btn btn-default" id="submit" > Enter </button>
...
var dataString = "pid="+ pid +"&vcode="+ vcode +"&vid="+ vid;
//alert(dataString);
...
$.ajax({
type: "POST",
url: "vaccination_add2.php",
data:dataString,
cache: true,
success: function(html){
$("#flash").html(html).hide();
