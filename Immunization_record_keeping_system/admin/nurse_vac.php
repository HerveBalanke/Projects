...
<div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">Nurse's Vaccinations</h1> <br/>
          </div>
        </div>
        <div id='replace' >
                <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <div id="imaginary_container"> 
                <div class="input-group stylish-input-group">
                    <input type="text" class="form-control" id="search" placeholder="Search by Nurse's Firtsname">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <table class="table table-hover table-striped">
                <thead>
                  <tr>
                  <th>Nurse Firstname</th>
                  <th>Nurse Lastname</th>
                  <th>List of Vaccination</th>
            ...
            ?>
                  ...
                  <tr>
                  <td><?php print $list["fname"]; ?> </a> </td>
                  <td><?php print $list["lname"]; ?> </a> </td>
                  <td><a href="nurse_vac_list.php?nid=<?php print $list["nid"]; ?>">View</a></td>
