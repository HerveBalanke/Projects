...
<html>
 ...
 <body>
  ...
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="s_registration.php">Registar Nurse</a></li> 
    ...
    <input type="hidden" class="form-control" id="pid" value="<?php print $lis["nid"]; ?>">
  </div>
              <div class="form-group">
                <div class="col-sm-2">
...
success: function(html){
  //$("#sec").load("form.php");
$("#flash").html(html);
setTimeout(' window.location.href = "view_staff.php"; ',2000);
