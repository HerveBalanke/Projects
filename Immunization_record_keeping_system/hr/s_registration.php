 ...
 <body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">Nurse Registration</h1> <br/>
          </div>
        </div>
          <div class="row">
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-8" id="sec">
            <form class="form-horizontal"  id="register" role="form" action="s_registration.php" method="POST">
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="fname" class="control-label">Firstname</label>
                </div>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="fname" name="fname" placeholder="Firstname" maxlength="30">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="lname" placeholder="Lastname" maxlength="30">
              ...
              <div class="form-group">
                <div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
                  <input type="radio" name="gender" id="gender"   value="M" > <span >Male</span>  <br/>
                  <input type="radio" name="gender" id="gender"  value="F" > <span >Female</span> 
  ...
  <option value="1930">1930</option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="telephone" class="form-control" id="tel" placeholder="0123456789" maxlength="10">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="email" name="email" placeholder="FIS@gmail.com" maxlength="30">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="add" placeholder="32 Cresent Labone" maxlength="50">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="button" name="submit" class="btn btn-default" id="submit"> Save </button>
