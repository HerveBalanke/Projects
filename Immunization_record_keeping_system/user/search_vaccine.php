  ...
  <div class="row">
          ...
          <div class="col-md-12">
            ...
            ?>
                  ...
                  <td class='edit'><a href="edit_vac.php?vid=<?php print $list["vid"]; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                  <td class='del'><a href="javascript:delete_id(<?php echo $list["vid"]; ?>)"><span class="glyphicon glyphicon-trash"></span></a></td>
                  </tr>
