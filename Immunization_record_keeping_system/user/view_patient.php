...
<html>
    ...
    <?php
          ...
          try{
            ...
            $out=$cons->query("select * from patient") or die (print_r($out->errorInfo()));
            $row= $out-> rowCount();
...
<div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">List of Patient</h1> <br/><br/>
        <div id='replace' >
<div class="row">
  ...
  <br/><br/>
   ...
   <?php 
            ...
            ?>
                  ...
                  <td><a href="history.php?pid=<?php print $list["pid"]; ?>" style="color:#009900">History</a></td>
                  <td ><a href="edit_patient.php?pid=<?php print $list["pid"]; ?>"><span class="glyphicon glyphicon-edit" style="color:orange"></span></a></td>
                  <td><a href="javascript:delete_id(<?php echo $list["pid"]; ?>)"><span class="glyphicon glyphicon-trash" style="color:red"></span></a></td>
