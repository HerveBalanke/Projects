      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
              ...
              <form class="form-horizontal" role="form" action="vac_qty.php" method="POST">
...
if (qid.length == 0) {
$('#check_qid').html("*Please select <strong>Vaccine Code</strong>"); // This Segment Displays The Validation Rule For All Fields
$("#qid").focus(); 
...
$('#check_qty').html("*<strong>Quantity should be between 0 and 999 </strong>"); // This Segment Displays The Validation Rule For All Fields
$("#qty").focus(); 
