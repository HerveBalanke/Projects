        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            ?>
                  ...
                  <tr><th>Edit</th><td><a href="edit_vac.php?vid=<?php print $list["vid"]; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                  </td></tr>
                  <tr ><th>Delete</th><td><a href="javascript:delete_id(<?php echo $list["vid"]; ?>)"><span class="glyphicon glyphicon-trash"></span></a></td></tr>                
            <?php   
                  }
            ?>
